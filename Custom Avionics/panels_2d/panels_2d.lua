...
defineProperty("show_absu_panel",globalPropertyi("sim/custom/panels/show_absu_panel")) 
...
defineProperty("show_checklist_panel",globalPropertyi("sim/custom/panels/show_checklist_panel")) 
defineProperty("show_ground_panel",globalPropertyi("sim/custom/panels/show_ground_panel")) 
defineProperty("show_phone",globalPropertyi("sim/custom/panels/show_phone")) 
defineProperty("show_cam",globalPropertyi("sim/custom/panels/show_cam")) 
defineProperty("show_palette",globalPropertyi("sim/custom/panels/show_palette")) 
