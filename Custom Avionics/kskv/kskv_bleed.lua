...
defineProperty("engine_bleed_sov_1", globalPropertyf("sim/cockpit2/bleedair/actuators/engine_bleed_sov[0]")) 
defineProperty("engine_bleed_sov_2", globalPropertyf("sim/cockpit2/bleedair/actuators/engine_bleed_sov[1]")) 
defineProperty("engine_bleed_sov_3", globalPropertyf("sim/cockpit2/bleedair/actuators/engine_bleed_sov[2]")) 
defineProperty("frame_time", globalPropertyf("tu154ce/time/frame_time")) 
defineProperty("ismaster", globalPropertyf("scp/api/ismaster")) 
defineProperty("hascontrol_1", globalPropertyf("scp/api/hascontrol_1")) 
local air_usage_tbl = {{ -100000, 0.0 },    
                  {  0, 00 }, 
				  { 60, 250 },   
				  {  65, 400 }, 
				  {  70, 600 }, 
