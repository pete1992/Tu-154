...
defineProperty("psvp_left_on", globalPropertyi("sim/custom/switchers/airbleed/psvp_left_on")) 
defineProperty("psvp_right_on", globalPropertyi("sim/custom/switchers/airbleed/psvp_right_on")) 
defineProperty("psvp_left_on_cap", globalPropertyi("sim/custom/switchers/airbleed/psvp_left_on_cap")) 
defineProperty("psvp_right_on_cap", globalPropertyi("sim/custom/switchers/airbleed/psvp_right_on_cap")) 
defineProperty("air_valve_left", globalPropertyi("sim/custom/switchers/airbleed/air_valve_left")) 
defineProperty("air_valve_right", globalPropertyi("sim/custom/switchers/airbleed/air_valve_right")) 
defineProperty("emerg_decompress", globalPropertyi("sim/custom/switchers/airbleed/emerg_decompress")) 
defineProperty("emerg_decompress_cap", globalPropertyi("sim/custom/switchers/airbleed/emerg_decompress_cap")) 
