...
defineProperty("sard_panel_lit", globalPropertyf("sim/custom/lights/sard_panel_lit")) 
...
defineProperty("sard_abs_press_set", globalPropertyf("sim/custom/switchers/sard/sard_abs_press_set")) 
defineProperty("sard_diff_set", globalPropertyf("sim/custom/switchers/sard/sard_diff_set")) 
defineProperty("sard_spd_set", globalPropertyf("sim/custom/switchers/sard/sard_spd_set")) 
defineProperty("emerg_decompress", globalPropertyi("sim/custom/switchers/airbleed/emerg_decompress")) 
defineProperty("sard_disable", globalPropertyi("sim/custom/switchers/eng/sard_disable")) 
