defineProperty("cabin_sel", globalPropertyi("tu154ce/switchers/airbleed/cabin_sel")) 
defineProperty("cockpit_temp_set", globalPropertyi("tu154ce/switchers/airbleed/cockpit_temp_set")) 
defineProperty("cabin1_temp_set", globalPropertyi("tu154ce/switchers/airbleed/cabin1_temp_set")) 
defineProperty("cabin2_temp_set", globalPropertyi("tu154ce/switchers/airbleed/cabin2_temp_set")) 
defineProperty("cockpit_mode_set", globalPropertyi("tu154ce/switchers/airbleed/cockpit_mode_set")) 
defineProperty("cabin1_mode_set", globalPropertyi("tu154ce/switchers/airbleed/cabin1_mode_set")) 
defineProperty("cabin2_mode_set", globalPropertyi("tu154ce/switchers/airbleed/cabin2_mode_set")) 
defineProperty("heat_close", globalPropertyi("tu154ce/switchers/airbleed/heat_close")) 
defineProperty("heat_close_cap", globalPropertyi("tu154ce/switchers/airbleed/heat_close_cap")) 
defineProperty("left_sys_temp_set", globalPropertyi("tu154ce/switchers/airbleed/left_sys_temp_set")) 
defineProperty("right_sys_temp_set", globalPropertyi("tu154ce/switchers/airbleed/right_sys_temp_set")) 
defineProperty("left_sys_mode_set", globalPropertyi("tu154ce/switchers/airbleed/left_sys_mode_set")) 
defineProperty("right_sys_mode_set", globalPropertyi("tu154ce/switchers/airbleed/right_sys_mode_set")) 
defineProperty("ground_cond_on", globalPropertyi("tu154ce/switchers/airbleed/ground_cond_on")) 
defineProperty("ground_cond_on_cap", globalPropertyi("tu154ce/switchers/airbleed/ground_cond_on_cap")) 
defineProperty("skv_faster_work", globalPropertyi("tu154ce/switchers/airbleed/skv_faster_work")) 
defineProperty("skv_faster_work_cap", globalPropertyi("tu154ce/switchers/airbleed/skv_faster_work_cap")) 
defineProperty("sys_temp_select", globalPropertyi("tu154ce/switchers/airbleed/sys_temp_select")) 
defineProperty("psvp_left_on", globalPropertyi("tu154ce/switchers/airbleed/psvp_left_on")) 
defineProperty("psvp_right_on", globalPropertyi("tu154ce/switchers/airbleed/psvp_right_on")) 
defineProperty("psvp_left_on_cap", globalPropertyi("tu154ce/switchers/airbleed/psvp_left_on_cap")) 
defineProperty("psvp_right_on_cap", globalPropertyi("tu154ce/switchers/airbleed/psvp_right_on_cap")) 
defineProperty("air_valve_left", globalPropertyi("tu154ce/switchers/airbleed/air_valve_left")) 
defineProperty("air_valve_right", globalPropertyi("tu154ce/switchers/airbleed/air_valve_right")) 
defineProperty("air_valve_both", globalPropertyi("tu154ce/switchers/airbleed/air_valve_both")) 
defineProperty("emerg_decompress", globalPropertyi("tu154ce/switchers/airbleed/emerg_decompress")) 
defineProperty("emerg_decompress_cap", globalPropertyi("tu154ce/switchers/airbleed/emerg_decompress_cap")) 
defineProperty("eng_valve_1", globalPropertyi("tu154ce/switchers/airbleed/eng_valve_1")) 
defineProperty("eng_valve_2", globalPropertyi("tu154ce/switchers/airbleed/eng_valve_2")) 
defineProperty("eng_valve_3", globalPropertyi("tu154ce/switchers/airbleed/eng_valve_3")) 
defineProperty("dubler_on", globalPropertyi("tu154ce/switchers/airbleed/dubler_on")) 
defineProperty("dubler_on_cap", globalPropertyi("tu154ce/switchers/airbleed/dubler_on_cap")) 
defineProperty("sard_disable", globalPropertyi("tu154ce/switchers/eng/sard_disable")) 
defineProperty("sard_disable_cap", globalPropertyi("tu154ce/switchers/eng/sard_disable_cap")) 
defineProperty("door_heat", globalPropertyi("tu154ce/switchers/eng/door_heat")) 
defineProperty("lamp_test_srd", globalPropertyi("tu154ce/buttons/lamp_test_srd")) 
defineProperty("lamp_test_front", globalPropertyi("tu154ce/buttons/lamp_test_front")) 
defineProperty("day_night_set", globalPropertyf("tu154ce/lights/day_night_set")) 
defineProperty("srd_buzzer_test", globalPropertyf("tu154ce/buttons/eng/srd_buzzer_test")) 
defineProperty("skv_overheat", globalPropertyf("tu154ce/lights/small/skv_overheat")) 
defineProperty("skv_overpress_left", globalPropertyf("tu154ce/lights/small/skv_overpress_left")) 
defineProperty("skv_overpress_right", globalPropertyf("tu154ce/lights/small/skv_overpress_right")) 
defineProperty("skv_tail_temp", globalPropertyf("tu154ce/lights/small/skv_tail_temp")) 
defineProperty("skv_bleed_fail_1", globalPropertyf("tu154ce/lights/small/skv_bleed_fail_1")) 
defineProperty("skv_bleed_fail_2", globalPropertyf("tu154ce/lights/small/skv_bleed_fail_2")) 
defineProperty("skv_bleed_fail_3", globalPropertyf("tu154ce/lights/small/skv_bleed_fail_3")) 
defineProperty("skv_bleed_closed_1", globalPropertyf("tu154ce/lights/small/skv_bleed_closed_1")) 
defineProperty("skv_bleed_closed_2", globalPropertyf("tu154ce/lights/small/skv_bleed_closed_2")) 
defineProperty("skv_bleed_closed_3", globalPropertyf("tu154ce/lights/small/skv_bleed_closed_3")) 
defineProperty("srd_low_press", globalPropertyf("tu154ce/lights/small/srd_low_press")) 
defineProperty("srd_overpress", globalPropertyf("tu154ce/lights/small/srd_overpress")) 
defineProperty("cockpit_p_low", globalPropertyf("tu154ce/lights/cockpit_p_low")) 
defineProperty("cockpit_temp_gau", globalPropertyf("tu154ce/gauges/airbleed/cockpit_temp")) 
defineProperty("cabin_temp_gau", globalPropertyf("tu154ce/gauges/airbleed/cabin_temp")) 
defineProperty("system_temp", globalPropertyf("tu154ce/gauges/airbleed/system_temp")) 
defineProperty("air_flow_1", globalPropertyf("tu154ce/gauges/airbleed/air_flow_1")) 
defineProperty("air_flow_2", globalPropertyf("tu154ce/gauges/airbleed/air_flow_2")) 
...
defineProperty("eng_airvalve_1", globalPropertyf("tu154ce/bleed/eng_airvalve_1")) 
defineProperty("eng_airvalve_2", globalPropertyf("tu154ce/bleed/eng_airvalve_2")) 
defineProperty("eng_airvalve_3", globalPropertyf("tu154ce/bleed/eng_airvalve_3")) 
...
defineProperty("door_heat_tube_t", globalPropertyf("tu154ce/bleed/door_heat_tube_t")) 
defineProperty("cockpit_tube_t", globalPropertyf("tu154ce/bleed/cockpit_tube_t")) 
defineProperty("cabin1_tube_t", globalPropertyf("tu154ce/bleed/cabin1_tube_t")) 
defineProperty("cabin2_tube_t", globalPropertyf("tu154ce/bleed/cabin2_tube_t")) 
defineProperty("cold_tube1_t", globalPropertyf("tu154ce/bleed/cold_tube1_t")) 
defineProperty("cold_tube2_t", globalPropertyf("tu154ce/bleed/cold_tube2_t")) 
defineProperty("cockpit_temp", globalPropertyf("tu154ce/bleed/cockpit_temp")) 
defineProperty("cabin_1_temp", globalPropertyf("tu154ce/bleed/cabin_1_temp")) 
defineProperty("cabin_2_temp", globalPropertyf("tu154ce/bleed/cabin_2_temp")) 
defineProperty("hot_tube_t", globalPropertyf("tu154ce/bleed/hot_tube_t")) 
...
defineProperty("airbleed_1", globalPropertyi("tu154ce/failures/airbleed_1")) 
defineProperty("airbleed_2", globalPropertyi("tu154ce/failures/airbleed_2")) 
defineProperty("airbleed_3", globalPropertyi("tu154ce/failures/airbleed_3")) 
defineProperty("main_pressure", globalPropertyi("tu154ce/alarm/main_pressure")) 
...
local function lamps()
	...
	local skv_overpress_left_brt = math.max(0, test_btn) 
	set(skv_overpress_left, skv_overpress_left_brt)	
	local skv_overpress_right_brt = math.max(0, test_btn) 
	set(skv_overpress_right, skv_overpress_right_brt)	
	local skv_tail_temp_brt = math.max(0, test_btn) 
