defineProperty("lamp_test", globalPropertyi("sim/custom/buttons/lamp_test_fire_panel")) 
defineProperty("lamp_test_2", globalPropertyi("sim/custom/buttons/lamp_test_engines")) 
defineProperty("smoke_test", globalPropertyi("sim/custom/buttons/eng/smoke_test")) 
defineProperty("ext_test", globalPropertyi("sim/custom/buttons/eng/ext_test")) 
defineProperty("lamp_test_front", globalPropertyi("sim/custom/buttons/lamp_test_front")) 
defineProperty("fire_ext_1", globalPropertyi("sim/custom/buttons/eng/fire_ext_1")) 
defineProperty("fire_ext_2", globalPropertyi("sim/custom/buttons/eng/fire_ext_2")) 
defineProperty("fire_ext_3", globalPropertyi("sim/custom/buttons/eng/fire_ext_3")) 
defineProperty("cold_eng_1", globalPropertyi("sim/custom/buttons/eng/cold_eng_1")) 
defineProperty("cold_eng_2", globalPropertyi("sim/custom/buttons/eng/cold_eng_2")) 
defineProperty("cold_eng_3", globalPropertyi("sim/custom/buttons/eng/cold_eng_3")) 
defineProperty("cold_apu", globalPropertyi("sim/custom/buttons/eng/cold_apu")) 
defineProperty("neutral_gas", globalPropertyi("sim/custom/buttons/eng/neutral_gas")) 
defineProperty("fire_sensor_sel", globalPropertyi("sim/custom/switchers/eng/fire_sensor_sel")) 
defineProperty("fire_place_sel", globalPropertyi("sim/custom/switchers/eng/fire_place_sel")) 
defineProperty("fire_main_switch", globalPropertyi("sim/custom/switchers/eng/fire_main_switch")) 
defineProperty("fire_buzzer", globalPropertyi("sim/custom/switchers/eng/fire_buzzer")) 
defineProperty("fire_buzzer_cap", globalPropertyi("sim/custom/switchers/eng/fire_buzzer_cap")) 
defineProperty("smoke_1", globalPropertyf("sim/custom/lights/fire/smoke_1")) 
defineProperty("smoke_2", globalPropertyf("sim/custom/lights/fire/smoke_2")) 
defineProperty("smoke_zone2_left", globalPropertyf("sim/custom/lights/fire/smoke_zone2_left")) 
defineProperty("smoke_zone2_right", globalPropertyf("sim/custom/lights/fire/smoke_zone2_right")) 
defineProperty("smoke_zone3", globalPropertyf("sim/custom/lights/fire/smoke_zone3")) 
defineProperty("smoke_zone4", globalPropertyf("sim/custom/lights/fire/smoke_zone4")) 
defineProperty("smoke_zone5_left", globalPropertyf("sim/custom/lights/fire/smoke_zone5_left")) 
defineProperty("smoke_zone5_right", globalPropertyf("sim/custom/lights/fire/smoke_zone5_right")) 
defineProperty("smoke_zone6", globalPropertyf("sim/custom/lights/fire/smoke_zone6")) 
defineProperty("fire_eng_1", globalPropertyf("sim/custom/lights/fire/fire_eng_1")) 
defineProperty("fire_eng_2", globalPropertyf("sim/custom/lights/fire/fire_eng_2")) 
defineProperty("fire_eng_3", globalPropertyf("sim/custom/lights/fire/fire_eng_3")) 
defineProperty("overheat_eng_1", globalPropertyf("sim/custom/lights/fire/overheat_eng_1")) 
defineProperty("overheat_eng_2", globalPropertyf("sim/custom/lights/fire/overheat_eng_2")) 
defineProperty("overheat_eng_3", globalPropertyf("sim/custom/lights/fire/overheat_eng_3")) 
defineProperty("fuel_off_eng_1", globalPropertyf("sim/custom/lights/fire/fuel_off_eng_1")) 
defineProperty("fuel_off_eng_2", globalPropertyf("sim/custom/lights/fire/fuel_off_eng_2")) 
defineProperty("fuel_off_eng_3", globalPropertyf("sim/custom/lights/fire/fuel_off_eng_3")) 
defineProperty("check_overheat", globalPropertyf("sim/custom/lights/fire/check_overheat")) 
defineProperty("fire_apu", globalPropertyf("sim/custom/lights/fire/fire_apu")) 
defineProperty("turn_on_spz", globalPropertyf("sim/custom/lights/fire/turn_on_spz")) 
defineProperty("button_fire_eng_1", globalPropertyf("sim/custom/lights/button/fire_eng_1")) 
defineProperty("button_fire_eng_2", globalPropertyf("sim/custom/lights/button/fire_eng_2")) 
defineProperty("button_fire_eng_3", globalPropertyf("sim/custom/lights/button/fire_eng_3")) 
defineProperty("button_fire_apu", globalPropertyf("sim/custom/lights/button/fire_apu")) 
defineProperty("button_fire_ng", globalPropertyf("sim/custom/lights/button/fire_ng")) 
defineProperty("button_fire_turn_3", globalPropertyf("sim/custom/lights/button/fire_turn_3")) 
defineProperty("button_fire_turn_2", globalPropertyf("sim/custom/lights/button/fire_turn_2")) 
defineProperty("button_fire_turn_1", globalPropertyf("sim/custom/lights/button/fire_turn_1")) 
defineProperty("throttle_1_fire", globalPropertyf("sim/custom/lights/small/throttle_1_fire")) 
defineProperty("throttle_2_fire", globalPropertyf("sim/custom/lights/small/throttle_2_fire")) 
defineProperty("throttle_3_fire", globalPropertyf("sim/custom/lights/small/throttle_3_fire")) 
defineProperty("fire_lamp", globalPropertyf("sim/custom/lights/fire")) 
...
defineProperty("ext_used_1", globalPropertyi("sim/custom/fire/ext_used_1")) 
defineProperty("ext_used_2", globalPropertyi("sim/custom/fire/ext_used_2")) 
defineProperty("ext_used_3", globalPropertyi("sim/custom/fire/ext_used_3")) 
defineProperty("ng_used", globalPropertyi("sim/custom/fire/ng_used")) 
defineProperty("valve_open_1", globalPropertyi("sim/custom/fire/valve_open_1")) 
defineProperty("valve_open_2", globalPropertyi("sim/custom/fire/valve_open_2")) 
defineProperty("valve_open_3", globalPropertyi("sim/custom/fire/valve_open_3")) 
defineProperty("valve_open_4", globalPropertyi("sim/custom/fire/valve_open_4")) 
defineProperty("engine_fire_state_1", globalPropertyi("sim/custom/fire/engine_fire_state_1")) 
defineProperty("engine_fire_state_2", globalPropertyi("sim/custom/fire/engine_fire_state_2")) 
defineProperty("engine_fire_state_3", globalPropertyi("sim/custom/fire/engine_fire_state_3")) 
defineProperty("engine_fire_state_4", globalPropertyi("sim/custom/fire/engine_fire_state_4")) 
defineProperty("engine_fuel_cut_1", globalPropertyi("sim/custom/fire/engine_fuel_cut_1")) 
defineProperty("engine_fuel_cut_2", globalPropertyi("sim/custom/fire/engine_fuel_cut_2")) 
defineProperty("engine_fuel_cut_3", globalPropertyi("sim/custom/fire/engine_fuel_cut_3")) 
...
defineProperty("fire_detected", globalPropertyi("sim/custom/fire/fire_detected")) 
...
local function swichers_check()
	...
	if changes_rot ~= 0 then playSample(rotary_sound, 0) end 
	...
	if fire_buzzer_cap_sw ~= fire_buzzer_cap_last then playSample(cap_sound, 0) end 
...
local function lamps()
	...
	local test_btn_2 = get(lamp_test_2) * math.max((get(bus27_volt_right) - 10) / 18.5, 0)
	local test_btn_frnt = get(lamp_test_front) * math.max((get(bus27_volt_right) - 10) / 18.5, 0)
	...
	local smoke_1_brt = math.max(smoke_test_but * power_sw * lamps_brt * day_night, test_btn) 
	set(smoke_1, smoke_1_brt)
	local smoke_2_brt = math.max(smoke_test_but * power_sw * lamps_brt * day_night, test_btn) 
	set(smoke_2, smoke_2_brt)	
	local smoke_zone2_left_brt = math.max(smoke_test_but * power_sw * lamps_brt * day_night, test_btn) 
	set(smoke_zone2_left, smoke_zone2_left_brt)
	local smoke_zone2_right_brt = math.max(smoke_test_but * power_sw * lamps_brt * day_night, test_btn) 
	set(smoke_zone2_right, smoke_zone2_right_brt)
	local smoke_zone3_brt = math.max(smoke_test_but * power_sw * lamps_brt * day_night, test_btn) 
	set(smoke_zone3, smoke_zone3_brt)
	local smoke_zone4_brt = math.max(smoke_test_but * power_sw * lamps_brt * day_night, test_btn) 
	set(smoke_zone4, smoke_zone4_brt)
	local smoke_zone5_left_brt = math.max(smoke_test_but * power_sw * power_sw * lamps_brt * day_night, test_btn) 
	set(smoke_zone5_left, smoke_zone5_left_brt)
	local smoke_zone5_right_brt = math.max(smoke_test_but * power_sw * lamps_brt * day_night, test_btn) 
	set(smoke_zone5_right, smoke_zone5_right_brt)
	local smoke_zone6_brt = math.max(smoke_test_but * power_sw * lamps_brt * day_night, test_btn) 
