defineProperty("msrp_mlp_main", globalPropertyf("sim/custom/lights/small/msrp_mlp_main")) 
defineProperty("msrp_mlp_aux", globalPropertyf("sim/custom/lights/small/msrp_mlp_aux")) 
defineProperty("msrp_up2", globalPropertyf("sim/custom/lights/small/msrp_up2")) 
defineProperty("msrp_mars", globalPropertyf("sim/custom/lights/small/msrp_mars")) 
defineProperty("lamp_test_msrp", globalPropertyf("sim/custom/buttons/lamp_test_msrp")) 
defineProperty("msrp_date_ten", globalPropertyi("sim/custom/switchers/eng/msrp_date_ten")) 
defineProperty("msrp_date_one", globalPropertyi("sim/custom/switchers/eng/msrp_date_one")) 
defineProperty("msrp_month_ten", globalPropertyi("sim/custom/switchers/eng/msrp_month_ten")) 
defineProperty("msrp_month_one", globalPropertyi("sim/custom/switchers/eng/msrp_month_one")) 
defineProperty("msrp_year_ten", globalPropertyi("sim/custom/switchers/eng/msrp_year_ten")) 
defineProperty("msrp_year_one", globalPropertyi("sim/custom/switchers/eng/msrp_year_one")) 
defineProperty("msrp_route_hun", globalPropertyi("sim/custom/switchers/eng/msrp_route_hun")) 
defineProperty("msrp_route_ten", globalPropertyi("sim/custom/switchers/eng/msrp_route_ten")) 
defineProperty("msrp_route_one", globalPropertyi("sim/custom/switchers/eng/msrp_route_one")) 
defineProperty("msrp_mlp_1", globalPropertyi("sim/custom/switchers/eng/msrp_mlp_1")) 
defineProperty("msrp_mlp_2", globalPropertyi("sim/custom/switchers/eng/msrp_mlp_2")) 
defineProperty("msrp_night_day", globalPropertyi("sim/custom/switchers/eng/msrp_night_day")) 
defineProperty("msrp_main_switch", globalPropertyi("sim/custom/switchers/eng/msrp_main_switch")) 
