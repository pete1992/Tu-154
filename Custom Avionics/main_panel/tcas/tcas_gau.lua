...
defineProperty("var_on", globalPropertyi("sim/custom/switchers/ovhd/var_left"))  
defineProperty("tcas_on", globalPropertyi("sim/custom/switchers/ovhd/tcas_on"))  
defineProperty("vsi_brt", globalPropertyf("sim/custom/gauges/vsi/vsi_brt_left"))  
defineProperty("vvi", globalPropertyf("sim/cockpit2/gauges/indicators/vvi_fpm_pilot")) 
defineProperty("vvi_int", globalPropertyf("sim/custom/gauges/vvi_left")) 
