defineProperty("wing_light", globalPropertyi("sim/custom/switchers/eng/wing_light")) 
defineProperty("gear_fan", globalPropertyi("sim/custom/switchers/eng/gear_fan")) 
defineProperty("galley_heat", globalPropertyi("sim/custom/switchers/eng/galley_heat")) 
defineProperty("lavatory_heat", globalPropertyi("sim/custom/switchers/eng/lavatory_heat")) 
defineProperty("water_meter", globalPropertyi("sim/custom/switchers/eng/water_meter")) 
defineProperty("water_compressor_1", globalPropertyi("sim/custom/switchers/eng/water_compressor_1")) 
defineProperty("water_compressor_2", globalPropertyi("sim/custom/switchers/eng/water_compressor_2")) 
defineProperty("tail_temp_signal", globalPropertyi("sim/custom/switchers/eng/tail_temp_signal")) 
defineProperty("tail_temp_heat", globalPropertyi("sim/custom/switchers/eng/tail_temp_heat")) 
defineProperty("tail_temp_signal_control_1", globalPropertyi("sim/custom/buttons/eng/tail_temp_signal_control_1")) 
defineProperty("tail_temp_signal_control_2", globalPropertyi("sim/custom/buttons/eng/tail_temp_signal_control_2")) 
...
defineProperty("water_pressure", globalPropertyf("sim/custom/gauges/eng/water_pressure")) 
defineProperty("water_level_1", globalPropertyf("sim/custom/lights/water_level_1")) 
defineProperty("water_level_12", globalPropertyf("sim/custom/lights/water_level_12")) 
defineProperty("water_level_14", globalPropertyf("sim/custom/lights/water_level_14")) 
defineProperty("water_level_0", globalPropertyf("sim/custom/lights/water_level_0")) 
...
defineProperty("water_lvl", globalPropertyf("sim/custom/misc/water_level")) 
...
local function lamps()
	...
	local water_level_1_brt = math.max(bool2int(water_level >= 0.9 and level_meter) * lamps_brt, test_btn, test_btn_2) 
	set(water_level_1, water_level_1_brt)
	local water_level_12_brt = math.max(bool2int(water_level < 0.9 and water_level >= 0.5 and level_meter) * lamps_brt, test_btn, test_btn_2) 
	set(water_level_12, water_level_12_brt)
	local water_level_14_brt = math.max(bool2int(water_level < 0.5 and water_level >= 0.25 and level_meter) * lamps_brt, test_btn, test_btn_2) 
	set(water_level_14, water_level_14_brt)
	local water_level_0_brt = math.max(bool2int(water_level < 0.25 and water_level >= 0 and level_meter) * lamps_brt, test_btn, test_btn_2) 
	set(water_level_0, water_level_0_brt)
	local tail_temp_high_brt = math.max(bool2int(get(tail_temp_signal_control_1) + get(tail_temp_signal_control_2) > 0) * get(tail_temp_signal) * lamps_brt, test_btn) 
	set(tail_temp_high, tail_temp_high_brt)
	local lavatory_heat_brt = math.max(bool2int(get(lavatory_heat) < 0) * lamps_brt, test_btn) 
	set(lavatory_heat_lamp, lavatory_heat_brt)
	local galley_heat_brt = math.max(bool2int(get(galley_heat) < 0) * lamps_brt, test_btn) 
