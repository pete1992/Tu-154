...
defineProperty("rsbn_azimuth_ind", globalPropertyf("sim/custom/gauges/misc/rsbn_azimuth_ind")) 
defineProperty("rsbn_distance_km", globalPropertyf("sim/custom/gauges/misc/rsbn_distance_km")) 
defineProperty("rsbn_km_one", globalPropertyf("sim/custom/gauges/misc/rsbn_km_one")) 
defineProperty("rsbn_km_ten", globalPropertyf("sim/custom/gauges/misc/rsbn_km_ten")) 
defineProperty("rsbn_km_hun", globalPropertyf("sim/custom/gauges/misc/rsbn_km_hun")) 
defineProperty("dist_autonom", globalPropertyf("sim/custom/lights/dist_autonom")) 
defineProperty("azimuth_autonom", globalPropertyf("sim/custom/lights/azimuth_autonom")) 
set(dist_autonom, 1)
