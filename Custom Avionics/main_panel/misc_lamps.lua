...
defineProperty("dh_lamp", globalPropertyf("sim/custom/lights/decision_height")) 
defineProperty("to_not_ready", globalPropertyf("sim/custom/lights/to_not_ready")) 
defineProperty("fuel_less_2500", globalPropertyf("sim/custom/lights/fuel_less_2500")) 
defineProperty("sso_danger", globalPropertyf("sim/custom/lights/sso_danger")) 
defineProperty("sso_connect", globalPropertyf("sim/custom/lights/sso_connect")) 
defineProperty("speed_high", globalPropertyf("sim/custom/lights/speed_high")) 
defineProperty("damper_course", globalPropertyf("sim/custom/lights/damper_course")) 
defineProperty("damper_roll", globalPropertyf("sim/custom/lights/damper_roll")) 
defineProperty("damper_pitch", globalPropertyf("sim/custom/lights/damper_pitch")) 
defineProperty("no_reserve_c", globalPropertyf("sim/custom/lights/no_reserve_c")) 
defineProperty("no_reserve_g", globalPropertyf("sim/custom/lights/no_reserve_g")) 
defineProperty("msg_lamp", globalPropertyf("sim/custom/lights/msg_lamp")) 
defineProperty("wpt_lamp", globalPropertyf("sim/custom/lights/wpt_lamp")) 
defineProperty("stuard_call", globalPropertyf("sim/custom/lights/stuard_call")) 
...
defineProperty("nav1_fail", globalPropertyi("sim/custom/failures/nav1_fail")) 
defineProperty("nav2_fail", globalPropertyi("sim/custom/failures/nav2_fail")) 
