...
defineProperty("absu_at_dif", globalPropertyf("sim/custom/absu_at_dif_left")) 
...
defineProperty("pitch_corr_hdl", globalPropertyf("sim/custom/gauges/ahz/pitch_corr_L")) 
defineProperty("pkp_on", globalPropertyi("sim/custom/switchers/ovhd/pkp_left_on")) 
defineProperty("pkp_fail", globalPropertyi("sim/custom/bkk/pkp_fail_left")) 
...
defineProperty("power_cc", globalPropertyf("sim/custom/bkk/pkp_left_power_cc")) 
...
defineProperty("res_pitch", globalPropertyf("sim/custom/gauges/ahz/pitch_L")) 
defineProperty("pitch_int", globalPropertyf("sim/custom/gyro/ahz_pitch_int_L")) 
defineProperty("res_roll", globalPropertyf("sim/custom/gauges/ahz/roll_L")) 
defineProperty("res_roll_bkk", globalPropertyf("sim/custom/bkk/pkp_roll_left")) 
defineProperty("course_plank", globalPropertyf("sim/custom/gauges/ahz/course_plank_L")) 
defineProperty("gs_plank", globalPropertyf("sim/custom/gauges/ahz/gs_plank_L")) 
defineProperty("dir_roll", globalPropertyf("sim/custom/gauges/ahz/dir_roll_L")) 
defineProperty("dir_pitch", globalPropertyf("sim/custom/gauges/ahz/dir_pitch_L")) 
defineProperty("speed_plank", globalPropertyf("sim/custom/gauges/ahz/speed_plank_L")) 
defineProperty("dir_roll_flag", globalPropertyf("sim/custom/gauges/ahz/dir_roll_flag_L")) 
defineProperty("dir_pitch_flag", globalPropertyf("sim/custom/gauges/ahz/dir_pitch_flag_L")) 
defineProperty("ahz_flag", globalPropertyf("sim/custom/gauges/ahz/ahz_flag_L")) 
