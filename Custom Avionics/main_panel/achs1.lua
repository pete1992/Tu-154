...
defineProperty("needle_hours_1", globalPropertyf("sim/custom/gauges/acs1/needle_hours"))
defineProperty("needle_mins_1", globalPropertyf("sim/custom/gauges/acs1/needle_mins"))
defineProperty("flight_timer_hours_1", globalPropertyf("sim/custom/gauges/acs1/flight_timer_hours"))
defineProperty("flight_timer_mins_1", globalPropertyf("sim/custom/gauges/acs1/flight_timer_mins"))
defineProperty("stopwatch_mins_1", globalPropertyf("sim/custom/gauges/acs1/stopwatch_mins"))
defineProperty("needle_secs_1", globalPropertyf("sim/custom/gauges/acs1/needle_secs"))
defineProperty("LK1", globalPropertyi("sim/custom/gauges/acs1/left_knob_press"))
defineProperty("RK1", globalPropertyi("sim/custom/gauges/acs1/right_knob_press"))
defineProperty("flag_pos_1", globalPropertyi("sim/custom/gauges/acs1/flag_pos"))
defineProperty("needle_hours_2", globalPropertyf("sim/custom/gauges/acs2/needle_hours"))
defineProperty("needle_mins_2", globalPropertyf("sim/custom/gauges/acs2/needle_mins"))
defineProperty("flight_timer_hours_2", globalPropertyf("sim/custom/gauges/acs2/flight_timer_hours"))
defineProperty("flight_timer_mins_2", globalPropertyf("sim/custom/gauges/acs2/flight_timer_mins"))
defineProperty("stopwatch_mins_2", globalPropertyf("sim/custom/gauges/acs2/stopwatch_mins"))
defineProperty("needle_secs_2", globalPropertyf("sim/custom/gauges/acs2/needle_secs"))
defineProperty("LK2", globalPropertyi("sim/custom/gauges/acs2/left_knob_press"))
defineProperty("RK2", globalPropertyi("sim/custom/gauges/acs2/right_knob_press"))
defineProperty("flag_pos_2", globalPropertyi("sim/custom/gauges/acs2/flag_pos"))
defineProperty("needle_hours_3", globalPropertyf("sim/custom/gauges/acs3/needle_hours"))
defineProperty("needle_mins_3", globalPropertyf("sim/custom/gauges/acs3/needle_mins"))
defineProperty("flight_timer_hours_3", globalPropertyf("sim/custom/gauges/acs3/flight_timer_hours"))
defineProperty("flight_timer_mins_3", globalPropertyf("sim/custom/gauges/acs3/flight_timer_mins"))
defineProperty("stopwatch_mins_3", globalPropertyf("sim/custom/gauges/acs3/stopwatch_mins"))
defineProperty("needle_secs_3", globalPropertyf("sim/custom/gauges/acs3/needle_secs"))
defineProperty("LK3", globalPropertyi("sim/custom/gauges/acs3/left_knob_press"))
defineProperty("RK3", globalPropertyi("sim/custom/gauges/acs3/right_knob_press"))
defineProperty("flag_pos_3", globalPropertyi("sim/custom/gauges/acs3/flag_pos"))
