...
defineProperty("course_ga", globalPropertyf("sim/custom/tks/course_ga_1")) 
defineProperty("course_bgmk", globalPropertyf("sim/custom/tks/course_bgmk_1")) 
...
defineProperty("obs", globalPropertyf("sim/custom/gauges/compas/pkp_obs_set_L"))  
defineProperty("obs_side", globalPropertyf("sim/custom/gauges/compas/pkp_obs_set_R"))  
defineProperty("frame_time", globalPropertyf("sim/custom/time/frame_time")) 
defineProperty("gyro_fail", globalPropertyi("sim/custom/tks/fail_left")) 
...
defineProperty("nav_course_1", globalPropertyi("sim/custom/rotary/console/nav_1_course")) 
defineProperty("nav_course_2", globalPropertyi("sim/custom/rotary/console/nav_2_course")) 
defineProperty("obs1", globalPropertyi("sim/cockpit2/radios/actuators/nav1_obs_deg_mag_pilot")) 
defineProperty("obs2", globalPropertyi("sim/cockpit2/radios/actuators/nav2_obs_deg_mag_pilot")) 
...
defineProperty("GNS430_flag", globalPropertyi("sim/custom/SC/GNS430_flag")) 
...
defineProperty("pnp_mode", globalPropertyi("sim/custom/switchers/ovhd/curs_pnp_mode_1")) 
defineProperty("pkp_obs_knob", globalPropertyf("sim/custom/gauges/compas/pkp_obs_knob_L")) 
defineProperty("absu_pnp_mode", globalPropertyi("sim/custom/absu/absu_pnp_mode_1")) 
...
defineProperty("tks_on", globalPropertyi("sim/custom/switchers/ovhd/tks_on_1")) 
defineProperty("pkp_gyro_course", globalPropertyf("sim/custom/gauges/compas/pkp_gyro_course_L")) 
defineProperty("pkp_obs", globalPropertyf("sim/custom/gauges/compas/pkp_obs_L")) 
defineProperty("pkp_helper_course", globalPropertyf("sim/custom/gauges/compas/pkp_helper_course_L")) 
defineProperty("pkp_slip_angle", globalPropertyf("sim/custom/gauges/compas/pkp_slip_angle_L")) 
defineProperty("pkp_course_plank", globalPropertyf("sim/custom/gauges/compas/pkp_course_plank_L")) 
defineProperty("pkp_gs_plank", globalPropertyf("sim/custom/gauges/compas/pkp_gs_plank_L")) 
defineProperty("pkp_gs_flag", globalPropertyi("sim/custom/gauges/compas/pkp_gs_flag_L")) 
defineProperty("pkp_course_flag", globalPropertyi("sim/custom/gauges/compas/pkp_course_flag_L")) 
defineProperty("pkp_main_flag", globalPropertyi("sim/custom/gauges/compas/pkp_main_flag_L")) 
defineProperty("pkp_obs_flag", globalPropertyi("sim/custom/gauges/compas/pkp_obs_flag_L")) 
defineProperty("pkp_obs_one", globalPropertyf("sim/custom/gauges/compas/pkp_obs_one_L")) 
defineProperty("pkp_obs_ten", globalPropertyf("sim/custom/gauges/compas/pkp_obs_ten_L")) 
defineProperty("pkp_obs_hundr", globalPropertyf("sim/custom/gauges/compas/pkp_obs_hundr_L")) 
defineProperty("pnp_sp_lamp", globalPropertyf("sim/custom/lights/small/pnp_sp_left")) 
defineProperty("pnp_vor_lamp", globalPropertyf("sim/custom/lights/small/pnp_vor_left")) 
defineProperty("pnp_nv_lamp", globalPropertyf("sim/custom/lights/small/pnp_nv_left")) 
