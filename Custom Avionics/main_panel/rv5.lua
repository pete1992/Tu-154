...
defineProperty("test_btn", globalPropertyf("sim/custom/gauges/alt/radioalt_button_left"))  
defineProperty("rv_on", globalPropertyi("sim/custom/switchers/ovhd/rv5_1_on"))  
defineProperty("rv_fail", globalPropertyi("sim/custom/failures/rv1_fail"))  
...
defineProperty("rv5_dh_signal", globalPropertyi("sim/custom/misc/rv5_dh_signal_left"))
defineProperty("rv_lamp", globalPropertyf("sim/custom/lights/small/rv5_left_dh"))  
defineProperty("rv_сс", globalPropertyf("sim/custom/elec/rv5_left_cc"))  
local alt2angle = {
{-100000, 0},
{0, 0},
{20, 30},
