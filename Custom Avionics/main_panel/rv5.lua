...
defineProperty("test_btn", globalPropertyf("tu154ce/gauges/alt/radioalt_button_left"))  
defineProperty("rv_on", globalPropertyi("tu154ce/switchers/ovhd/rv5_1_on"))  
defineProperty("rv_fail", globalPropertyi("tu154ce/failures/rv1_fail"))  
...
defineProperty("rv_сс", globalPropertyf("tu154ce/elec/rv5_left_cc"))  
local alt2angle = {
{-100000, 0},
{0, 0},
{20, 30},
