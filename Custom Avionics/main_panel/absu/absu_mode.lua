defineProperty("absu_zpu_sel", globalPropertyi("tu154ce/switchers/console/absu_zpu_sel")) 
...
defineProperty("absu_needles_on", globalPropertyi("tu154ce/switchers/console/absu_needles_on")) 
defineProperty("absu_speed_mode", globalPropertyi("tu154ce/switchers/console/absu_speed_mode")) 
...
defineProperty("absu_roll_ch_on", globalPropertyi("tu154ce/switchers/console/absu_roll_ch_on")) 
defineProperty("absu_pitch_ch_on", globalPropertyi("tu154ce/switchers/console/absu_pitch_ch_on")) 
defineProperty("absu_smooth_on", globalPropertyi("tu154ce/switchers/console/absu_smooth_on")) 
defineProperty("absu_turn_handle", globalPropertyi("tu154ce/switchers/console/absu_turn_handle")) 
defineProperty("absu_pitch_wheel", globalPropertyi("tu154ce/switchers/console/absu_pitch_wheel")) 
defineProperty("hydro_ra56_rud_1", globalPropertyi("tu154ce/switchers/eng/hydro_ra56_rud_1")) 
defineProperty("hydro_ra56_rud_2", globalPropertyi("tu154ce/switchers/eng/hydro_ra56_rud_2")) 
defineProperty("hydro_ra56_rud_3", globalPropertyi("tu154ce/switchers/eng/hydro_ra56_rud_3")) 
defineProperty("hydro_ra56_ail_1", globalPropertyi("tu154ce/switchers/eng/hydro_ra56_ail_1")) 
defineProperty("hydro_ra56_ail_2", globalPropertyi("tu154ce/switchers/eng/hydro_ra56_ail_2")) 
defineProperty("hydro_ra56_ail_3", globalPropertyi("tu154ce/switchers/eng/hydro_ra56_ail_3")) 
defineProperty("hydro_ra56_elev_1", globalPropertyi("tu154ce/switchers/eng/hydro_ra56_elev_1")) 
defineProperty("hydro_ra56_elev_2", globalPropertyi("tu154ce/switchers/eng/hydro_ra56_elev_2")) 
defineProperty("hydro_ra56_elev_3", globalPropertyi("tu154ce/switchers/eng/hydro_ra56_elev_3")) 
defineProperty("sau_stu_on", globalPropertyi("tu154ce/switchers/ovhd/sau_stu_on"))  
...
defineProperty("absu_az1", globalPropertyi("tu154ce/buttons/console/absu_az1")) 
defineProperty("absu_az2", globalPropertyi("tu154ce/buttons/console/absu_az2")) 
...
defineProperty("absu_arrest", globalPropertyi("tu154ce/buttons/console/absu_arrest")) 
defineProperty("absu_speed_test_1", globalPropertyi("tu154ce/buttons/console/absu_speed_test_1")) 
defineProperty("absu_speed_test_2", globalPropertyi("tu154ce/buttons/console/absu_speed_test_2")) 
...
defineProperty("absu_power_cc", globalPropertyf("tu154ce/absu_power_cc")) 
defineProperty("nvu_mode", globalPropertyi("tu154ce/nvu/nvu_mode")) 
...
defineProperty("rv_flag", globalPropertyi("tu154ce/gauges/alt/radioalt_flag_left"))  
defineProperty("absu_course_out", globalPropertyi("tu154ce/absu_course_out")) 
defineProperty("absu_gs_out", globalPropertyi("tu154ce/absu_gs_out")) 
...
defineProperty("pressure_ind_1", globalPropertyf("tu154ce/gauges/hydro/pressure_ind_1")) 
defineProperty("pressure_ind_2", globalPropertyf("tu154ce/gauges/hydro/pressure_ind_2")) 
defineProperty("pressure_ind_3", globalPropertyf("tu154ce/gauges/hydro/pressure_ind_3")) 
...
defineProperty("gs_press_4", globalPropertyf("tu154ce/hydro/gs_press_4")) 
defineProperty("tks_fail_left", globalPropertyi("tu154ce/tks/fail_left")) 
defineProperty("tks_fail_right", globalPropertyi("tu154ce/tks/fail_right")) 
...
defineProperty("absu_pnp_mode_1", globalPropertyi("tu154ce/absu/absu_pnp_mode_1")) 
defineProperty("absu_pnp_mode_2", globalPropertyi("tu154ce/absu/absu_pnp_mode_2")) 
...
defineProperty("absu_use_second_nav", globalPropertyi("tu154ce/absu_use_second_nav")) 
...
defineProperty("absu_fail_signal", globalPropertyi("tu154ce/absu/absu_fail_signal")) 
...
if MASTER then	
	...
	local power = get(bus27_volt_left) > 13 and get(bus27_volt_right) > 13 and get(bus115_3_volt) > 110 and get(bus36_volt_left) > 30 and get(bus36_volt_right) > 30 and get(bus36_volt_pts250_1) and sau_sw 
	...
	if sau_sw ~= sau_sw_last and sau_sw then 
	...
	if roll_mode_main == 2 and math.abs(get(joy_roll)) > 0.2 then 
		roll_mode_main = 1
	end
	if pitch_mode_main == 2 and math.abs(get(joy_pitch)) > 0.2 then 
		pitch_mode_main = 1
	...
	if roll_mode_main > 0 then 
		if roll_submode == 0 then roll_submode = 1 end
		if get(absu_zk) == 1 and roll_mode_main == 2 then 
			roll_submode = 2
		elseif get(absu_nvu) == 1 and get(nvu_mode) >= 1 and not land_prep then 
			roll_submode = 3
		elseif get(absu_az1) == 1 and nav_prep and not land_prep then 
			roll_submode = 4
		elseif get(absu_az2) == 1 and nav_prep and not land_prep then 
			roll_submode = 5
		elseif get(absu_app) == 1 and land_prep and ((isILS(get(freq_1)) and get(nav_cs_flag_1) == 0) or get(absu_use_second_nav) == 1) then 
			roll_submode = 6
		elseif get(absu_app) == 1 and land_prep then 
			roll_submode = 10
		elseif roll_submode == 10 and land_prep and ((isILS(get(freq_1)) and get(nav_cs_flag_1) == 0) or get(absu_use_second_nav) == 1) then 
			roll_submode = 6
		elseif reset_but or math.abs(roll_handle) > 1 then 
			roll_submode = 1
		elseif (roll_submode == 6 or roll_submode == 10) and roll_mode_main >= 1 and pitch_mode_main >= 1 and (rud_toga or TOGA_mode) then 
			roll_mode_main = 2
			pitch_mode_main = 2
			roll_submode = 1
			pitch_submode = 6
	...
	if roll_submode == 4 and roll_mode_main == 2 and (isILS(get(freq_1)) or get(nav_cs_flag_1) == 1) then 
		roll_submode = 1
	elseif roll_submode == 5 and roll_mode_main == 2 and (isILS(get(freq_2)) or get(nav_cs_flag_2) == 1) then 
		roll_submode = 1
	elseif roll_submode == 6 and (not isILS(get(freq_1)) or get(nav_cs_flag_1) == 1 or not land_prep) and pitch_submode == 5 and roll_mode_main == 2 then 
		roll_submode = 1
		roll_mode_main = 1
	...
	elseif roll_submode == 6 and (not isILS(get(freq_1)) or get(nav_cs_flag_1) == 1 or not land_prep) and roll_mode_main == 2 then 
		roll_submode = 1
		if get(nav_cs_flag_1) == 1 or not isILS(get(freq_1)) then
			set(man_roll_lamp, 1)
			set(absu_fail_signal, 1)
	...
	if pitch_mode_main > 0 then
		...
		if get(absu_stab_v) == 1 and pitch_mode_main == 2 and svs then 
			pitch_submode = 2
		elseif get(absu_stab_m) == 1 and pitch_mode_main == 2 and svs then 
			pitch_submode = 3
		elseif get(absu_stab_h) == 1 and pitch_mode_main == 2 and svs then 
			pitch_submode = 4
		elseif get(absu_gs) == 1 and land_prep and ((isILS(get(freq_1)) and get(nav_gs_flag_1) == 0) or (get(absu_use_second_nav) == 1) and get(nav_gs_flag_2) == 0) then 
			pitch_submode = 5
		elseif land_prep and get(nav_gs_flag_1) == 0 and roll_submode == 6 and math.abs(get(nav_gs_1)) < 0.02 and flaps > 31 then 
			pitch_submode = 5
		elseif get(absu_gs) == 1 and land_prep then 
			pitch_submode = 10
		elseif pitch_submode == 10 and land_prep and ((isILS(get(freq_1)) and get(nav_gs_flag_1) == 0) or (get(absu_use_second_nav) == 1) and get(nav_gs_flag_2) == 0) then 
			pitch_submode = 5
		elseif pitch_wheel_last ~= putch_wheel or (reset_but and pitch_submode >= 5) then 
			pitch_submode = 1
		elseif pitch_mode_main == 1 and (pitch_submode == 2 or pitch_submode == 3 or pitch_submode == 4) then 
			pitch_submode = 1
		end
	else 
		pitch_submode = 0
	...
	if pitch_mode_main == 2 and (not isILS(get(freq_1)) or not land_prep or get(nav_gs_flag_1) == 1) and pitch_submode == 5 then 
		pitch_submode = 1
		pitch_mode_main = 1
	...
	if get(absu_damp_roll_fail) == 1 then roll_mode_main = 0 end 
	if get(absu_damp_pitch_fail) == 1 then pitch_mode_main = 0 end 
	if get(absu_contr_roll_fail) == 1 and roll_mode_main == 2 then roll_mode_main = 1 end 
	if get(absu_contr_pitch_fail) == 1 and pitch_mode_main == 2 then pitch_mode_main = 1 end 
	if get(absu_calc_toga_fail) == 1 and roll_mode_main >=1 and pitch_mode_main >= 1 and pitch_submode == 6 then roll_mode_main = 1 pitch_mode_main = 1 end 
	if get(absu_calc_roll_fail) == 1 and roll_mode_main >= 1 then roll_submode = 1 end 
	if get(absu_calc_pitch_fail) == 1 and pitch_mode_main >= 1 then pitch_submode = 1 end 
