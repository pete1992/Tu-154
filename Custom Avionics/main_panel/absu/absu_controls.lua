...
defineProperty("absu_pitch_wheel", globalPropertyi("sim/custom/switchers/console/absu_pitch_wheel")) 
...
defineProperty("absu_use_second_nav", globalPropertyi("sim/custom/absu_use_second_nav")) 
defineProperty("pkp_course_L", globalPropertyf("sim/custom/gauges/compas/pkp_helper_course_L")) 
defineProperty("pkp_course_R", globalPropertyf("sim/custom/gauges/compas/pkp_helper_course_R")) 
defineProperty("pkp_gyro_course_L", globalPropertyf("sim/custom/gauges/compas/pkp_gyro_course_L")) 
defineProperty("pkp_gyro_course_R", globalPropertyf("sim/custom/gauges/compas/pkp_gyro_course_R")) 
defineProperty("pkp_obs_1", globalPropertyf("sim/custom/gauges/compas/pkp_obs_L")) 
defineProperty("pkp_obs_2", globalPropertyf("sim/custom/gauges/compas/pkp_obs_R")) 
...
defineProperty("roll_acc", globalPropertyf("sim/flightmodel/position/P_dot")) 
defineProperty("pitch_acc", globalPropertyf("sim/flightmodel/position/Q_dot")) 
defineProperty("yaw_acc", globalPropertyf("sim/flightmodel/position/R_dot")) 
...
defineProperty("obs_1", globalPropertyf("sim/cockpit2/radios/actuators/nav1_obs_deg_mag_pilot")) 
defineProperty("obs_2", globalPropertyf("sim/cockpit2/radios/actuators/nav2_obs_deg_mag_pilot")) 
defineProperty("nav_cs_1", globalPropertyf("sim/custom/radio/nav1_cs")) 
defineProperty("nav_cs_2", globalPropertyf("sim/custom/radio/nav2_cs")) 
defineProperty("nav_gs_1", globalPropertyf("sim/custom/radio/nav1_gs")) 
defineProperty("nav_gs_2", globalPropertyf("sim/custom/radio/nav2_gs")) 
defineProperty("freq_1", globalPropertyf("sim/cockpit2/radios/actuators/nav1_frequency_hz"))  
defineProperty("freq_2", globalPropertyf("sim/cockpit2/radios/actuators/nav2_frequency_hz"))  
defineProperty("nav_cs_flag_1", globalPropertyi("sim/custom/radio/nav1_cs_flag"))
defineProperty("nav_gs_flag_1", globalPropertyi("sim/custom/radio/nav1_gs_flag"))
defineProperty("nav_cs_flag_2", globalPropertyi("sim/custom/radio/nav2_cs_flag"))
defineProperty("nav_gs_flag_2", globalPropertyi("sim/custom/radio/nav2_gs_flag"))
defineProperty("cr_flag_1", globalPropertyf("sim/cockpit2/radios/indicators/nav1_flag_from_to_pilot")) 
defineProperty("cr_flag_2", globalPropertyf("sim/cockpit2/radios/indicators/nav2_flag_from_to_pilot")) 
...
defineProperty("GNS430_dtk", globalPropertyf("sim/custom/SC/GNS430_dtk")) 
defineProperty("GNS430_dev", globalPropertyf("sim/custom/SC/GNS430_dev")) 
defineProperty("rv5_alt", globalPropertyf("sim/custom/misc/rv5_alt_left"))  
defineProperty("dh_set", globalPropertyf("sim/custom/gauges/alt/radioalt_dh_left"))  
defineProperty("rv_angle", globalPropertyf("sim/custom/gauges/alt/radioalt_needle_left"))  
...
defineProperty("absu_roll_ind", globalPropertyf("sim/custom/absu/absu_roll_ind")) 
defineProperty("absu_pitch_ind", globalPropertyf("sim/custom/absu/absu_pitch_ind")) 
defineProperty("absu_roll_flag", globalPropertyi("sim/custom/absu/absu_roll_flag")) 
defineProperty("absu_pitch_flag", globalPropertyi("sim/custom/absu/absu_pitch_flag")) 
...
function update()
	...
	if pitch_mode >= 1 then 
		...
		elseif pitch_submode == 4 then 
			...
			local K_PH = line(mach, 0.3, 0.1, 0.8, 0.05) 
			local K_DH = line(mach, 0.3, 0.3, 0.8, 0.15) * (1 - absu_smooth * 0.5)
		...
		if pitch_mode == 1 then 
			...
			local elev_need = pitch_cmd * pitch_coef - pitch_W * 0.15 
	...
	if roll_mode >= 1 then 
		...
		if math.abs(roll_handle) <= 1 and roll_mode == 2 and roll_submode == 1 then 
			course_stab_timer = course_stab_timer + passed 
		else 
			course_stab_timer = 0
		...
		elseif roll_submode == 3 then 
			...
			local side_lim = 2400 
			local side_spd_lim = 160 
			local side = nvu_z * 1000 
		...
		elseif roll_submode == 4 or roll_submode == 5 then 
			...
			local course_now = get(course_gpk)
			local course_dev = get(nav_cs_1) * 10 
			if roll_submode == 5 then
				course_dev = get(nav_cs_2) * 10 
			end
			local pnp_course = get(pkp_obs_1)
			if get(absu_zpu_sel) == 1 then pnp_course = get(pkp_obs_2) end 
			vor_slip_act = vor_slip_act + (slip_angle - vor_slip_act) * passed * 0.5 
			if course_dev > vor_dev_lim then course_dev = vor_dev_lim
			elseif course_dev < -vor_dev_lim then course_dev = -vor_dev_lim end
			vor_dev_act = vor_dev_act + (course_dev - vor_dev_act) * passed * 0.5 
		...
		elseif roll_submode == 6 then 
			...
			if math.abs(course_dev) > 9 then 
				...
				if math.abs(ILS_spd_last - dev_spd) > 1 then 
					ILS_spd_limited = 0
					ILS_dev_limited = 0
				else
	...
	if roll_submode == 1 or roll_submode == 2 then 
		...
		elseif not app_on then
			...
			pitch_show = 0
		elseif app_on then
			if (not isILS(nav_1_fr) or nav_1_cs_flag) and not secondNav then 
				roll_show = 0
			else roll_show = 0
			end
			pitch_show = 0
	...
	elseif roll_submode == 4 then 
		...
		elseif not nav_on then
			...
			pitch_show = 0
		elseif nav_on then 
			if isILS(nav_1_fr) or nav_1_cs_flag then 
				roll_show = 0
			else
				roll_show = roll_show - roll_now
			end
	...
	elseif roll_submode == 5 then 
		...
		elseif not nav_on then
			...
			pitch_show = 0
		elseif nav_on then 
			if isILS(nav_2_fr) or nav_2_cs_flag then 
				roll_show = 0
			else
				roll_show = roll_show - roll_now
			end
	...
	elseif roll_submode == 6 and pitch_submode == 5 then 
		...
		elseif app_on then 
			...
			if (not isILS(nav_1_fr) or nav_1_gs_flag) and nav_2_gs_flag then 
				pitch_show = 0
			else
	...
	elseif roll_submode == 7 and pitch_submode == 6 then 
		...
		elseif not app_on then
			...
			pitch_show = 0
		elseif app_on then 
			if not isILS(nav_1_fr) or nav_1_cs_flag then 
				roll_show = 0
			else
				roll_show = 0
			end
...
function pitch_holder(pitch_hold) 
...
function roll_holder(roll_hold) 
...
function yaw_holder()
	...
	yaw_I = yaw_I - sign(yaw_I) * passed * 0.1 
