...
defineProperty("pitch_corr_hdl", globalPropertyf("sim/custom/gauges/ahz/pitch_corr_C")) 
...
defineProperty("res_pitch", globalPropertyf("sim/custom/gauges/ahz/pitch_C")) 
defineProperty("res_roll", globalPropertyf("sim/custom/gauges/ahz/roll_C")) 
defineProperty("agr_cc", globalPropertyf("sim/custom/ahz/agr_cc")) 
defineProperty("ahz_flag", globalPropertyf("sim/custom/gauges/ahz/ahz_flag_C")) 
