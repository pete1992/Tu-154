defineProperty("left_freq", globalPropertyf("sim/cockpit2/radios/actuators/adf1_left_frequency_hz"))  
defineProperty("right_freq", globalPropertyf("sim/cockpit2/radios/actuators/adf1_right_frequency_hz"))  
defineProperty("active", globalPropertyf("sim/cockpit2/radios/actuators/adf1_right_is_selected"))  
...
defineProperty("ark_mode", globalPropertyi("sim/custom/switchers/ovhd/ark_1_mode")) 
defineProperty("ark_channel", globalPropertyi("sim/custom/switchers/ovhd/ark_1_channel")) 
defineProperty("ark_hundr_left", globalPropertyi("sim/custom/switchers/ovhd/ark_1_hundr_left")) 
defineProperty("ark_tens_left", globalPropertyi("sim/custom/switchers/ovhd/ark_1_tens_left")) 
defineProperty("ark_ones_left", globalPropertyi("sim/custom/switchers/ovhd/ark_1_ones_left")) 
defineProperty("ark_hundr_right", globalPropertyi("sim/custom/switchers/ovhd/ark_1_hundr_right")) 
defineProperty("ark_tens_right", globalPropertyi("sim/custom/switchers/ovhd/ark_1_tens_right")) 
defineProperty("ark_ones_right", globalPropertyi("sim/custom/switchers/ovhd/ark_1_ones_right")) 
defineProperty("ark_ramka", globalPropertyi("sim/custom/buttons/ovhd/ark_1_ramka")) 
defineProperty("ark_left_lit", globalPropertyf("sim/custom/lights/ark1_left_lit")) 
defineProperty("ark_right_lit", globalPropertyf("sim/custom/lights/ark1_right_lit")) 
defineProperty("ark_all_lit", globalPropertyf("sim/custom/lights/ark1_all_lit")) 
...
defineProperty("ark15_cc", globalPropertyf("sim/custom/radio/ark15_L_cc")) 
defineProperty("adf_bear", globalPropertyf("sim/custom/radio/adf_bear_1"))
