...
defineProperty("VHF2Freq", globalPropertyf("sim/cockpit2/radios/actuators/com2_frequency_hz"))  
defineProperty("VHF1Freq", globalPropertyf("sim/cockpit2/radios/actuators/com1_frequency_hz"))  
defineProperty("spu_power_sw", globalPropertyi("sim/custom/switchers/spu_1_power"))
defineProperty("spu_mode", globalPropertyi("sim/custom/switchers/spu_1_mode"))
defineProperty("spu_source", globalPropertyi("sim/custom/switchers/spu_1_source"))
defineProperty("bus27_L", globalPropertyf("sim/custom/elec/bus27_volt_left"))
defineProperty("bus27_R", globalPropertyf("sim/custom/elec/bus27_volt_right"))
...
defineProperty("ark_mode_1", globalPropertyi("sim/custom/switchers/ovhd/ark_1_mode")) 
defineProperty("ark_mode_2", globalPropertyi("sim/custom/switchers/ovhd/ark_2_mode")) 
