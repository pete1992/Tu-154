...
defineProperty("frequency", globalPropertyf("sim/cockpit2/radios/actuators/com1_frequency_hz_833"))  
defineProperty("freq_sby", globalPropertyf("sim/cockpit2/radios/actuators/com1_standby_frequency_hz_833"))  
defineProperty("vhf_left", globalPropertyi("sim/custom/rotary/ovhd/vhf_1_left"))  
defineProperty("vhf_right", globalPropertyi("sim/custom/rotary/ovhd/vhf_1_right"))  
defineProperty("vhf_on", globalPropertyi("sim/custom/switchers/ovhd/vhf_1_on"))  
defineProperty("bus27_volt", globalPropertyf("sim/custom/elec/bus27_volt_left"))
defineProperty("spu_source", globalPropertyi("sim/custom/switchers/spu_1_source"))
defineProperty("com_power", globalPropertyi("sim/cockpit2/radios/actuators/com1_power"))
defineProperty("vhf_cc", globalPropertyf("sim/custom/radio/vhf1_cc"))
...
function update()
	...
	power = get(vhf_on) == 1 and get(bus27_volt) > 13 
