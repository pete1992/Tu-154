...
defineProperty("cr_flag", globalPropertyf("sim/cockpit2/radios/indicators/nav1_flag_from_to_pilot")) 
defineProperty("gs_flag", globalPropertyf("sim/cockpit/radios/nav1_CDI"))  
defineProperty("nav_deg", globalPropertyf("sim/cockpit2/radios/indicators/nav1_relative_bearing_deg")) 
defineProperty("sim_fail", globalPropertyi("sim/operation/failures/rel_nav1")) 
defineProperty("nav_fail", globalPropertyi("sim/custom/failures/nav1_fail")) 
defineProperty("dme_fail", globalPropertyi("sim/custom/failures/dme1_fail")) 
defineProperty("distance", globalPropertyf("sim/cockpit2/radios/indicators/nav1_dme_distance_nm"))  
...
defineProperty("curs_np_on", globalPropertyi("sim/custom/switchers/ovhd/curs_np_on_1")) 
defineProperty("nav_mode", globalPropertyi("sim/custom/switchers/nav_1_mode")) 
defineProperty("nav_man_auto", globalPropertyi("sim/custom/switchers/nav_1_man_auto")) 
defineProperty("nav_mile_km", globalPropertyi("sim/custom/switchers/nav_1_mile_km")) 
defineProperty("nav_left", globalPropertyi("sim/custom/rotary/ovhd/nav_1_left")) 
defineProperty("nav_right", globalPropertyi("sim/custom/rotary/ovhd/nav_1_right")) 
defineProperty("nav_but_1", globalPropertyi("sim/custom/buttons/ovhd/nav_1_but_1")) 
defineProperty("nav_but_2", globalPropertyi("sim/custom/buttons/ovhd/nav_1_but_2")) 
defineProperty("nav_but_3", globalPropertyi("sim/custom/buttons/ovhd/nav_1_but_3")) 
defineProperty("nav_course", globalPropertyi("sim/custom/rotary/console/nav_1_course")) 
...
defineProperty("nav_pow_cc", globalPropertyf("sim/custom/radio/nav1_pow_cc")) 
defineProperty("vor_dme", globalPropertyf("sim/custom/radio/vor_dme_1")) 
defineProperty("vor_bear", globalPropertyf("sim/custom/radio/vor_bear_1"))
...
defineProperty("nav_course_1", globalPropertyf("sim/custom/rotary/console/nav_1_course_1"))
defineProperty("nav_course_10", globalPropertyf("sim/custom/rotary/console/nav_1_course_10"))
defineProperty("nav_course_100", globalPropertyf("sim/custom/rotary/console/nav_1_course_100"))
defineProperty("nav_to_lit", globalPropertyf("sim/custom/lights/small/nav_1_to"))
defineProperty("nav_from_lit", globalPropertyf("sim/custom/lights/small/nav_1_from"))
...
if MASTER then
	...
	if bear > 90.01 or bear < 89.99 and power and not FAIL then 
		bearing = bear + (math.random() - 0.49999) * 30 * passed
	elseif power and not FAIL then 
	...
	local nav_flag = get(cr_flag) * bool2int(power)  
	local glide_flag = get(gs_flag) * bool2int(power)  
	lamps(nav_flag)
