size = {800, 600}
defineProperty("image_table") 
defineProperty("columns") 
...
function draw()
	...
	for x = 1, x_size, 1 do
		...
		if height > 660 then
			...
			drawRectangle((x-1) * x_coef, 520, x_coef, y, 1, 0.3, 0.3, 1) 
			drawRectangle((x-1) * x_coef, 390, x_coef, 130,1, 0.6, 0.2, 1) 
			drawRectangle((x-1) * x_coef, 260, x_coef, 130, 1, 0.8, 0.2, 1) 
			drawRectangle((x-1) * x_coef, 130, x_coef, 130, 1, 1, 0.3, 1) 
			drawRectangle((x-1) * x_coef, 0, x_coef, 130, 0.3, 1, 0.3, 1) 
		elseif height > 330 then
			local y = math.min((height - 330) * 0.39, 130)
			drawRectangle((x-1) * x_coef, 390, x_coef, y, 1, 0.6, 0.2, 1) 
			drawRectangle((x-1) * x_coef, 260, x_coef, 130, 1, 0.8, 0.2, 1) 
			drawRectangle((x-1) * x_coef, 130, x_coef, 130, 1, 1, 0.3, 1) 
			drawRectangle((x-1) * x_coef, 0, x_coef, 130, 0.3, 1, 0.3, 1) 
		elseif height > 0 then
			local y = height * 0.39
			drawRectangle((x-1) * x_coef, 260, x_coef, y, 1, 0.8, 0.2, 1) 
			drawRectangle((x-1) * x_coef, 130, x_coef, 130, 1, 1, 0.3, 1) 
			drawRectangle((x-1) * x_coef, 0, x_coef, 130, 0.3, 1, 0.3, 1) 
		elseif height > -330 then
			local y = -(-330 - height) * 0.39
			drawRectangle((x-1) * x_coef, 130, x_coef, y, 1, 1, 0.3, 1)	
			drawRectangle((x-1) * x_coef, 0, x_coef, 130, 0.3, 1, 0.3, 1) 
		elseif height > -660 then
			local y = -(-660 - height) * 0.39
			drawRectangle((x-1) * x_coef, 0, x_coef, y, 0.3, 1, 0.3, 1) 
		end
	end
	local vvi = get(v_spd)
	local speed = get(g_spd) 
	local step = get(range) * 1000 / 80 
