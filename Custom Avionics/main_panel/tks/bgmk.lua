...
defineProperty("course_mk_1", globalPropertyf("sim/custom/tks/course_mk_1")) 
defineProperty("course_mk_2", globalPropertyf("sim/custom/tks/course_mk_2")) 
...
defineProperty("fail1", globalPropertyi("sim/custom/failures/tks_bgmk1_fail")) 
defineProperty("fail2", globalPropertyi("sim/custom/failures/tks_bgmk2_fail")) 
