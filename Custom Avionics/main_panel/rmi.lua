defineProperty("course_bgmk", globalPropertyf("sim/custom/tks/course_bgmk_2")) 
defineProperty("frame_time", globalPropertyf("sim/custom/time/frame_time")) 
defineProperty("adf_bear_1", globalPropertyf("sim/custom/radio/adf_bear_1"))
defineProperty("adf_bear_2", globalPropertyf("sim/custom/radio/adf_bear_2"))
defineProperty("vor_bear_1", globalPropertyf("sim/custom/radio/vor_bear_1"))
defineProperty("vor_bear_2", globalPropertyf("sim/custom/radio/vor_bear_2"))
defineProperty("ark15_L_ON", globalPropertyf("sim/custom/radio/ark15_L_cc")) 
defineProperty("ark15_R_ON", globalPropertyf("sim/custom/radio/ark15_R_cc")) 
defineProperty("nav_L_ON", globalPropertyf("sim/custom/radio/nav1_pow_cc")) 
defineProperty("nav_R_ON", globalPropertyf("sim/custom/radio/nav2_pow_cc")) 
defineProperty("bus36_volt", globalPropertyf("sim/custom/elec/bus36_volt_right")) 
defineProperty("radiocomp_scale", globalPropertyf("sim/custom/gauges/compas/radiocomp_scale_left")) 
defineProperty("bearing_1", globalPropertyf("sim/custom/gauges/compas/bearing_1_left")) 
defineProperty("bearing_2", globalPropertyf("sim/custom/gauges/compas/bearing_2_left")) 
defineProperty("source_1_switch", globalPropertyi("sim/custom/gauges/compas/source_1_switch_left")) 
defineProperty("source_2_switch", globalPropertyi("sim/custom/gauges/compas/source_2_switch_left")) 
