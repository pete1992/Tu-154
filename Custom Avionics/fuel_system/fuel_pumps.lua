...
defineProperty("fuel_pumps_115_1_cc", globalPropertyf("tu154ce/elec/fuel_pumps_115_1_cc")) 
defineProperty("fuel_pumps_115_3_cc", globalPropertyf("tu154ce/elec/fuel_pumps_115_3_cc")) 
...
function update()
	...
	if power115 then
		if tanks_turn > 0 and get(fuel_flow_mode) == 1 then 
