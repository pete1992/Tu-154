...
defineProperty("fuel_fluct_1", globalPropertyi("sim/operation/failures/rel_fuelfl0")) 
defineProperty("fuel_fluct_2", globalPropertyi("sim/operation/failures/rel_fuelfl1")) 
defineProperty("fuel_fluct_3", globalPropertyi("sim/operation/failures/rel_fuelfl2")) 
...
if get(ismaster) ~= 1 then		
	...
	if FAIL > 0 then
		...
		if stall_counter > stall_time then
			...
			local altitude_ft = msl + (get(pressure) * 0.0295300586467 - get(msl_press)) * 1000  
