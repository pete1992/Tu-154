...
defineProperty("fuel_meter_on", globalPropertyi("tu154ce/switchers/fuel/fuel_meter_mech_on")) 
...
defineProperty("rpm_low_1", globalPropertyf("tu154ce/gauges/engine/rpm_low_1")) 
defineProperty("rpm_low_2", globalPropertyf("tu154ce/gauges/engine/rpm_low_2")) 
defineProperty("rpm_low_3", globalPropertyf("tu154ce/gauges/engine/rpm_low_3")) 
...
defineProperty("fuel_press_1", globalPropertyf("tu154ce/gauges/eng/fuel_press_1")) 
defineProperty("fuel_press_2", globalPropertyf("tu154ce/gauges/eng/fuel_press_2")) 
defineProperty("fuel_press_3", globalPropertyf("tu154ce/gauges/eng/fuel_press_3")) 
defineProperty("oil_press_1", globalPropertyf("tu154ce/gauges/eng/oil_press_1")) 
defineProperty("oil_press_2", globalPropertyf("tu154ce/gauges/eng/oil_press_2")) 
defineProperty("oil_press_3", globalPropertyf("tu154ce/gauges/eng/oil_press_3")) 
defineProperty("oil_temp_1", globalPropertyf("tu154ce/gauges/eng/oil_temp_1")) 
defineProperty("oil_temp_2", globalPropertyf("tu154ce/gauges/eng/oil_temp_2")) 
defineProperty("oil_temp_3", globalPropertyf("tu154ce/gauges/eng/oil_temp_3")) 
defineProperty("fuel_flow_1", globalPropertyf("tu154ce/gauges/eng/fuel_flow_1")) 
defineProperty("fuel_flow_2", globalPropertyf("tu154ce/gauges/eng/fuel_flow_2")) 
defineProperty("fuel_flow_3", globalPropertyf("tu154ce/gauges/eng/fuel_flow_3")) 
...
defineProperty("fuel_temp_1", globalPropertyf("tu154ce/gauges/eng/fuel_temp_1")) 
defineProperty("fuel_temp_2", globalPropertyf("tu154ce/gauges/eng/fuel_temp_2")) 
defineProperty("sim_egt_1", globalPropertyf("sim/cockpit2/engine/indicators/EGT_deg_C[0]")) 
defineProperty("sim_egt_2", globalPropertyf("sim/cockpit2/engine/indicators/EGT_deg_C[1]")) 
defineProperty("sim_egt_3", globalPropertyf("sim/cockpit2/engine/indicators/EGT_deg_C[2]")) 
...
defineProperty("vibration_1", globalPropertyf("tu154ce/eng/vibration_1")) 
defineProperty("vibration_2", globalPropertyf("tu154ce/eng/vibration_2")) 
defineProperty("vibration_3", globalPropertyf("tu154ce/eng/vibration_3")) 
...
defineProperty("eng1_N2", globalPropertyf("sim/flightmodel/engine/ENGN_N2_[0]")) 
defineProperty("eng2_N2", globalPropertyf("sim/flightmodel/engine/ENGN_N2_[1]")) 
defineProperty("eng3_N2", globalPropertyf("sim/flightmodel/engine/ENGN_N2_[2]")) 
...
defineProperty("emerg_inv115", globalPropertyi("tu154ce/switchers/eng/emerg_inv115")) 
...
local function emi3()
	...
	local oilT_3 = -50
	if power_36_L then 
		fuelP_1 = interpolate(fuel_P_table, get(fuel_p_1))
		oilP_1 = interpolate(oil_P_table, get(oil_p_1)) * 0.1
	end	
	if power_36_R then
		fuelP_2 = interpolate(fuel_P_table, get(fuel_p_2))
		fuelP_3 = interpolate(fuel_P_table, get(fuel_p_3))
		oilP_2 = interpolate(oil_P_table, get(oil_p_2)) * 0.1
		oilP_3 = interpolate(oil_P_table, get(oil_p_3)) * 0.1
	end
	if power_27_L then 
		oilT_1 = get(oil_t_1)
	end
...
local high_table_start = {{ -100000, 0.0 },    
                  {  0, 00 }, 
				  { 3, 0 },   
				  { 4, 5 },   
				  { 6, -1 },   
				  ...
				  {  99, 95 }, 
           	      {  110, 105 },    
          	      {  1000000000, 100 }}    
local high_gnd_table = {{ -100000, 0.0 },    
                  {  0, 00 }, 
				  { 23, 21 },   
				  {  71.3, 60.5 }, 
				  {  84.0, 82.5 }, 
				  ...
				  {  99, 95 }, 
           	      {  110, 105 },    
          	      {  1000000000, 100 }}    
local low_gnd_table = {{ -100000, 0.0 },    
                  {  0, 00 }, 
				  {  1, 3 }, 
				  {  36.3, 30 }, 
				  {  59.3, 59 }, 
				  ...
				  {  110, 98 },    
          	      {  1000000000, 100 }}    
local high_table_start_11km = {{ -100000, 0.0 },    
                  {  0, 00 }, 
				  { 3, 0 },   
				  { 4, 5 },   
				  { 6, -1 },   
				  ...
				  {  100.9, 96.5 }, 
           	      {  110, 100 },    
          	      {  1000000000, 100 }}    
local high_11km_table = {{ -100000, 0.0 },    
                  {  0, 00 }, 
				  { 23, 21 },   
				  {  82.4, 78.0 }, 
				  {  86.7, 82.25 }, 
				  ...
				  {  100.9, 96.5 }, 
           	      {  110, 100 },    
          	      {  1000000000, 100 }}    
local low_11km_table = {{ -100000, 0.0 },    
                  {  0, 00 }, 
				  {  1, 3 }, 
				  {  55.9, 63.0 }, 
				  {  65.3, 69.25 }, 
...
low_gnd_table = {{ -100000, 0.0 },    
				  ...
				  {  110, 98 },    
          	      {  1000000000, 100 }}    
high_table_start_11km = {{ -100000, 0.0 },    
                  {  0, 00 }, 
				  { 3, 0 },   
				  { 4, 5 },   
				  { 6, -1 },   
