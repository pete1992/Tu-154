...
defineProperty("eng1_fail", globalPropertyf("sim/operation/failures/rel_engfai0")) 
...
defineProperty("eng1_fire", globalPropertyf("sim/operation/failures/rel_engfir0")) 
...
defineProperty("eng1_oil_p", globalPropertyf("sim/flightmodel/engine/ENGN_oil_press_psi[0]"))  
