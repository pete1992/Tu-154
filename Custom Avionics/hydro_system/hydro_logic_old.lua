...
defineProperty("bak_qty_1", globalPropertyf("sim/custom/hydro/gs_bak_qty_1")) 
defineProperty("bak_qty_2", globalPropertyf("sim/custom/hydro/gs_bak_qty_2")) 
defineProperty("bak_qty_3", globalPropertyf("sim/custom/hydro/gs_bak_qty_3")) 
...
if MASTER then	
	...
	local hs1_qty = sys_qty_1 - 30 
	local hs2_qty = sys_qty_2 - 30 
	local hs3_qty = sys_qty_3 - 21 
