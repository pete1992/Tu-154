...
defineProperty("pressure_ind_emerg", globalPropertyf("sim/custom/gauges/hydro/pressure_ind_emerg")) 
defineProperty("qty_12", globalPropertyf("sim/custom/gauges/hydro/qty_12")) 
defineProperty("qty_3", globalPropertyf("sim/custom/gauges/hydro/qty_3")) 
...
defineProperty("lamp_test_hydro", globalPropertyi("sim/custom/buttons/lamp_test_hydro")) 
defineProperty("lamp_test_front", globalPropertyi("sim/custom/buttons/lamp_test_front")) 
defineProperty("qty_test_12", globalPropertyi("sim/custom/buttons/hydro/qty_test_12")) 
defineProperty("qty_test_3", globalPropertyi("sim/custom/buttons/hydro/qty_test_3")) 
...
defineProperty("connect2to1_cap", globalPropertyi("sim/custom/switchers/hydro/connect2to1_cap")) 
...
defineProperty("eng_hydr_fail_1", globalPropertyf("sim/custom/lights/small/eng_hydr_fail_1")) 
defineProperty("eng_hydr_fail_2", globalPropertyf("sim/custom/lights/small/eng_hydr_fail_2")) 
defineProperty("eng_hydr_fail_3", globalPropertyf("sim/custom/lights/small/eng_hydr_fail_3")) 
defineProperty("eng_hydr_fail_4", globalPropertyf("sim/custom/lights/small/eng_hydr_fail_4")) 
defineProperty("front_hydr_fail_1", globalPropertyf("sim/custom/lights/small/front_hydr_fail_1")) 
defineProperty("front_hydr_fail_2", globalPropertyf("sim/custom/lights/small/front_hydr_fail_2")) 
defineProperty("front_hydr_fail_3", globalPropertyf("sim/custom/lights/small/front_hydr_fail_3")) 
defineProperty("front_hydr_fail_4", globalPropertyf("sim/custom/lights/small/front_hydr_fail_4")) 
...
defineProperty("l_brake_add", globalPropertyf("sim/custom/brakes/int_brakes_L")) 
defineProperty("r_brake_add", globalPropertyf("sim/custom/brakes/int_brakes_R")) 
