...
defineProperty("overr", globalPropertyf("sim/operation/override/override_control_surfaces")) 
defineProperty("speedbrake_ratio", globalPropertyf("sim/cockpit2/controls/speedbrake_ratio")) 
defineProperty("elev_trimm_sw", globalPropertyi("tu154ce/controll/elev_trimm_switcher")) 
defineProperty("ail_trimm_sw", globalPropertyi("tu154ce/controll/ail_trimm_sw")) 
defineProperty("rudd_trimm_sw", globalPropertyi("tu154ce/controll/rudd_trimm_sw")) 
defineProperty("int_pitch_trim", globalPropertyf("tu154ce/trimmers/int_pitch_trim")) 
defineProperty("int_roll_trim", globalPropertyf("tu154ce/trimmers/int_roll_trim")) 
defineProperty("int_yaw_trim", globalPropertyf("tu154ce/trimmers/int_yaw_trim")) 
...
defineProperty("control_force_pos", globalPropertyf("tu154ce/controls/control_force_pos")) 
defineProperty("control_force_pos_rud", globalPropertyf("tu154ce/controls/control_force_pos_rud")) 
...
defineProperty("spd_brk_inn_anim_L", globalPropertyf("tu154ce/anim/spd_brk_inn_left")) 
defineProperty("spd_brk_inn_anim_R", globalPropertyf("tu154ce/anim/spd_brk_inn_right")) 
...
defineProperty("yoke_pitch", globalPropertyf("tu154ce/controlls/yoke_pitch")) 
defineProperty("yoke_roll", globalPropertyf("tu154ce/controlls/yoke_roll")) 
defineProperty("pedals_turn", globalPropertyf("tu154ce/controlls/pedals")) 
...
defineProperty("ctr_27_L_cc", globalPropertyf("tu154ce/control/ctr_27_L_cc")) 
defineProperty("ctr_27_R_cc", globalPropertyf("tu154ce/control/ctr_27_R_cc")) 
defineProperty("ctr_115_1_cc", globalPropertyf("tu154ce/control/ctr_115_1_cc")) 
defineProperty("ctr_115_2_cc", globalPropertyf("tu154ce/control/ctr_115_2_cc")) 
...
function update()
	...
	local left_ail_pos = roll_pos_act * 20 * line(mach, 0, 1, 0.8, 0.5) 
	local right_ail_pos = -roll_pos_act * 20 * line(mach, 0, 1, 0.8, 0.5) 
	local roll_sp_L = 0
...
if MASTER then
	...
	if pitch_pos_act >=0 then
		elev_left = -pitch_pos_act * (25 - stab_pos) 
		elev_right = -pitch_pos_act * (25 - stab_pos) 
	else
		elev_left = -pitch_pos_act * (20 + stab_pos * 0.5) 
		elev_right = -pitch_pos_act * (20 + stab_pos * 0.5) 
	end
	local elev_coef = 1 
...
if MASTER then	
	...
	local rudder_pos = yaw_pos_act * 25 * line(mach, 0, 1, 0.8, 0.5) 
