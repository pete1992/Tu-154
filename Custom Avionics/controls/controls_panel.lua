defineProperty("stab_man_cap", globalPropertyi("sim/custom/controll/stab_man_cap")) 
defineProperty("stab_manual", globalPropertyi("sim/custom/controll/stab_manual")) 
defineProperty("stab_setting", globalPropertyi("sim/custom/controll/stab_setting")) 
defineProperty("ail_trimm_sw", globalPropertyi("sim/custom/controll/ail_trimm_sw")) 
defineProperty("rudd_trimm_sw", globalPropertyi("sim/custom/controll/rudd_trimm_sw")) 
defineProperty("contr_force_cap", globalPropertyi("sim/custom/controll/contr_force_cap")) 
...
defineProperty("nosewheel_turn_cap", globalPropertyi("sim/custom/switchers/nosewheel_turn_cap")) 
defineProperty("slat_man", globalPropertyi("sim/custom/switchers/slat_man")) 
defineProperty("slat_man_cap", globalPropertyi("sim/custom/switchers/slat_man_cap")) 
defineProperty("flaps_sel", globalPropertyi("sim/custom/switchers/flaps_sel")) 
defineProperty("flaps_sel_cap", globalPropertyi("sim/custom/switchers/flaps_sel_cap")) 
defineProperty("gears_retr_lock", globalPropertyi("sim/custom/switchers/gears_retr_lock")) 
defineProperty("gears_retr_lock_cap", globalPropertyi("sim/custom/switchers/gears_retr_lock_cap")) 
defineProperty("gears_ext_3GS", globalPropertyi("sim/custom/switchers/gears_ext_3GS")) 
defineProperty("gears_ext_3GS_cap", globalPropertyi("sim/custom/switchers/gears_ext_3GS_cap")) 
...
defineProperty("emerg_elev_trimm_cap", globalPropertyi("sim/custom/switchers/console/emerg_elev_trimm_cap")) 
defineProperty("lamp_test", globalPropertyi("sim/custom/buttons/lamp_test_front")) 
defineProperty("lamp_test_eng", globalPropertyi("sim/custom/buttons/lamp_test_upper_gear")) 
...
defineProperty("elevator_ind", globalPropertyf("sim/custom/gauges/misc/elevator_ind")) 
...
defineProperty("stab_work", globalPropertyf("sim/custom/lights/stab_work")) 
defineProperty("flaps_1_valve", globalPropertyf("sim/custom/lights/flaps_1_valve")) 
defineProperty("flaps_2_valve", globalPropertyf("sim/custom/lights/flaps_2_valve")) 
...
defineProperty("spoilers_inn_left", globalPropertyf("sim/custom/lights/spoilers_inn_left")) 
defineProperty("spoilers_inn_right", globalPropertyf("sim/custom/lights/spoilers_inn_right")) 
defineProperty("flaps_unsync", globalPropertyf("sim/custom/lights/flaps_unsync")) 
defineProperty("slats_unsync", globalPropertyf("sim/custom/lights/slats_unsync")) 
defineProperty("slats_extended", globalPropertyf("sim/custom/lights/slats_extended")) 
defineProperty("to_rudder", globalPropertyf("sim/custom/lights/to_rudder")) 
defineProperty("to_elevator", globalPropertyf("sim/custom/lights/to_elevator")) 
...
defineProperty("gears_not_ext", globalPropertyf("sim/custom/lights/gears_not_ext")) 
defineProperty("gears_red_left", globalPropertyf("sim/custom/lights/gears_red_left")) 
defineProperty("gears_red_front", globalPropertyf("sim/custom/lights/gears_red_front")) 
defineProperty("gears_red_right", globalPropertyf("sim/custom/lights/gears_red_right")) 
defineProperty("gears_green_left", globalPropertyf("sim/custom/lights/gears_green_left")) 
defineProperty("gears_green_front", globalPropertyf("sim/custom/lights/gears_green_front")) 
defineProperty("gears_green_right", globalPropertyf("sim/custom/lights/gears_green_right")) 
defineProperty("gears_red_left_eng", globalPropertyf("sim/custom/lights/gears_red_left_eng")) 
defineProperty("gears_red_front_eng", globalPropertyf("sim/custom/lights/gears_red_front_eng")) 
defineProperty("gears_red_right_eng", globalPropertyf("sim/custom/lights/gears_red_right_eng")) 
defineProperty("gears_green_left_eng", globalPropertyf("sim/custom/lights/gears_green_left_eng")) 
defineProperty("gears_green_front_eng", globalPropertyf("sim/custom/lights/gears_green_front_eng")) 
defineProperty("gears_green_right_eng", globalPropertyf("sim/custom/lights/gears_green_right_eng")) 
...
defineProperty("stab_pos", globalPropertyf("sim/flightmodel2/controls/elevator_trim")) 
...
defineProperty("control_force_pos", globalPropertyf("sim/custom/controls/control_force_pos")) 
defineProperty("control_force_pos_rud", globalPropertyf("sim/custom/controls/control_force_pos_rud")) 
...
defineProperty("slats", globalPropertyf("sim/flightmodel2/controls/slat1_deploy_ratio")) 
defineProperty("rv5_alt_L", globalPropertyf("sim/custom/misc/rv5_alt_left"))  
defineProperty("rv5_alt_R", globalPropertyf("sim/custom/misc/rv5_alt_right"))  
