defineProperty("bus27_connect", globalPropertyi("tu154ce/switchers/eng/bus27_connect")) 
defineProperty("bus27_vu1", globalPropertyi("tu154ce/switchers/eng/bus27_vu1")) 
defineProperty("bus27_vu2", globalPropertyi("tu154ce/switchers/eng/bus27_vu2")) 
...
defineProperty("bat_source_1", globalPropertyi("tu154ce/elec/bat_is_source_1")) 
defineProperty("bat_source_2", globalPropertyi("tu154ce/elec/bat_is_source_2")) 
defineProperty("bat_source_3", globalPropertyi("tu154ce/elec/bat_is_source_3")) 
defineProperty("bat_source_4", globalPropertyi("tu154ce/elec/bat_is_source_4")) 
defineProperty("apu_system_on", globalPropertyi("tu154ce/eng/apu_system_on"))
defineProperty("apu_start_seq", globalPropertyi("tu154ce/elec/apu_start_seq")) 
defineProperty("vu1_volt", globalPropertyf("tu154ce/elec/vu1_volt")) 
defineProperty("vu2_volt", globalPropertyf("tu154ce/elec/vu2_volt")) 
defineProperty("vu_res_volt", globalPropertyf("tu154ce/elec/vu_res_volt")) 
...
defineProperty("apu_start_bus", globalPropertyf("tu154ce/elec/apu_start_bus")) 
defineProperty("apu_start_cc", globalPropertyf("tu154ce/elec/apu_start_cc")) 
...
defineProperty("bus27_amp_left", globalPropertyf("tu154ce/elec/bus27_amp_left")) 
defineProperty("bus27_amp_right", globalPropertyf("tu154ce/elec/bus27_amp_right")) 
defineProperty("bus27_source_left", globalPropertyf("tu154ce/elec/bus27_source_left")) 
defineProperty("bus27_source_right", globalPropertyf("tu154ce/elec/bus27_source_right")) 
defineProperty("buses_connected", globalPropertyi("tu154ce/elec/bus_connected"))
defineProperty("vu_res_to_L", globalPropertyi("tu154ce/elec/vu_res_to_L")) 
defineProperty("vu_res_to_R", globalPropertyi("tu154ce/elec/vu_res_to_R")) 
...
function update()
	if get(frame_time) > 0 then
		...
		if get(apu_start_seq) == 1 then 
			...
			if vu1_conn == 1 or vu2_conn == 1 or vu3_work then 
				source_L = 1
				source_R = 1
				bus_volt_L = 28.5
				bus_volt_R = 28.5
			...
			elseif get(gear_defl) > 0.05 then 
		...
		elseif get(bus27_connect) == 1 or get(apu_system_on) == 1 then 
			set(buses_connected, 1)
