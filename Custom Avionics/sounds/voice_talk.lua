defineProperty("reset_crew", globalPropertyi("tu154ce/sound/reset_crew")) 
...
defineProperty("parking_brake", globalPropertyi("tu154ce/controll/parking_brake")) 
...
defineProperty("turn_rate_ind", globalPropertyf("tu154ce/gauges/misc/turn_rate_ind")) 
defineProperty("big_course_needle", globalPropertyf("tu154ce/gauges/compas/big_course_needle")) 
...
defineProperty("spoilers_lever", globalPropertyf("tu154ce/controlls/spoilers_lever")) 
defineProperty("bat1_on", globalPropertyi("tu154ce/switchers/eng/bat1_on")) 
defineProperty("bat2_on", globalPropertyi("tu154ce/switchers/eng/bat2_on")) 
defineProperty("bat3_on", globalPropertyi("tu154ce/switchers/eng/bat3_on")) 
defineProperty("bat4_on", globalPropertyi("tu154ce/switchers/eng/bat4_on")) 
defineProperty("apu_main_switch", globalPropertyi("tu154ce/switchers/eng/apu_main_switch")) 
defineProperty("apu_start_mode", globalPropertyi("tu154ce/switchers/eng/apu_start_mode")) 
defineProperty("apu_n1", globalPropertyf("tu154ce/eng/apu_n1")) 
defineProperty("apu_fuel_p", globalPropertyf("tu154ce/eng/apu_fuel_p")) 
defineProperty("apu_doors", globalPropertyf("tu154ce/anim/apu_doors")) 
defineProperty("starter_pressure", globalPropertyf("tu154ce/start/starter_pressure")) 
defineProperty("starter_cap", globalPropertyi("tu154ce/switchers/eng/starter_cap")) 
defineProperty("starter_switch", globalPropertyi("tu154ce/switchers/eng/starter_switch")) 
defineProperty("starter_eng_select", globalPropertyi("tu154ce/switchers/eng/starter_eng_select")) 
defineProperty("starter_mode", globalPropertyi("tu154ce/switchers/eng/starter_mode")) 
defineProperty("starter_start", globalPropertyi("tu154ce/buttons/eng/starter_start")) 
defineProperty("apd_working_1", globalPropertyf("tu154ce/start/apd_working_1")) 
defineProperty("apd_working_2", globalPropertyf("tu154ce/start/apd_working_2")) 
defineProperty("apd_working_3", globalPropertyf("tu154ce/start/apd_working_3")) 
...
defineProperty("engine_caps", globalPropertyi("tu154ce/anim/engine_caps")) 
...
defineProperty("alt_mtr", globalPropertyf("tu154ce/gauges/alt/vbe_alt_left"))  
defineProperty("dh_set", globalPropertyf("tu154ce/gauges/alt/radioalt_dh_left"))  
defineProperty("rv_test_btn", globalPropertyf("tu154ce/gauges/alt/radioalt_button_left"))  
defineProperty("rv_angle", globalPropertyf("tu154ce/gauges/alt/radioalt_needle_left"))  
defineProperty("rv_lamp", globalPropertyf("tu154ce/lights/small/rv5_left_dh"))  
...
defineProperty("parking_brake", globalPropertyi("tu154ce/controll/parking_brake")) 
defineProperty("tks_course_set", globalPropertyi("tu154ce/switchers/ovhd/tks_course_set")) 
defineProperty("bat1_on", globalPropertyi("tu154ce/switchers/eng/bat1_on")) 
defineProperty("bat2_on", globalPropertyi("tu154ce/switchers/eng/bat2_on")) 
defineProperty("bat3_on", globalPropertyi("tu154ce/switchers/eng/bat3_on")) 
defineProperty("bat4_on", globalPropertyi("tu154ce/switchers/eng/bat4_on")) 
...
function regular_talk()
	...
	if v_var["on_ground"] 
		and flight_status ~= 9 
		and get(rpm_high_1) < 10 and get(rpm_high_2) < 10 and get(rpm_high_3) < 10 
		and get(parking_brake) == 1 
	then
		flight_status = 0
	...
	if flight_status == 0 
		and v_var["on_ground"] 
		and get(rpm_high_1) > 40 and get(rpm_high_2) > 40 and get(rpm_high_3) > 40 
		and get(rpm_high_1) < 90 and get(rpm_high_2) < 90 and get(rpm_high_3) < 90 
		and get(revers_flap_L) < 0.1 and get(revers_flap_R) < 0.1 
		and get(parking_brake) == 0 and get(l_brake_add) < 0.05 and get(r_brake_add) < 0.05 
	then
		flight_status = 1
		v_var["engine_TO_said"] = false
	...
	if v_var["on_ground"] 
		and (get(rpm_high_1) > 90 or get(rpm_high_2) > 90 or get(rpm_high_3) > 90) 
		and get(parking_brake) == 0 and get(l_brake_add) < 0.05 and get(r_brake_add) < 0.05 
		and get(revers_flap_L) < 0.1 and get(revers_flap_R) < 0.1 
	then
		flight_status = 2
	...
	if (flight_status == 2 or flight_status == 6 or flight_status == 7) 
		and (get(rpm_high_1) > 90 or get(rpm_high_2) > 90 or get(rpm_high_3) > 90) 
		and not v_var["on_ground"] 
		and get(VVI) > 4 
		and get(rv5_alt) > 150 
	then
		flight_status = 3
	...
	if not v_var["on_ground"] 
		and get(rv5_alt) > 550 
		and get(IAS) > 430 / 1.852 
		and get(VVI) < 4 and get(VVI) > -4 
	then
		flight_status = 4
	...
	if (flight_status == 3 or flight_status == 4) 
		and not v_var["on_ground"] 
		and get(VVI) < -4 
	then
		flight_status = 5
	...
	if (flight_status == 6 or flight_status == 2) 
		and v_var["on_ground"] 
		and get(groundspeed) > 5 / 3.6 and get(groundspeed) < 350 / 3.6 
		and (get(rpm_high_1) > 40 or get(rpm_high_2) > 40 or get(rpm_high_3) > 40) 
		and get(rpm_high_1) < 70 and get(rpm_high_2) < 70 and get(rpm_high_3) < 70 
	then
		flight_status = 8
	...
	if get(reset_crew) == 1 or (flight_status == 9
		and v_var["on_ground"] 
		and get(rpm_high_1) < 5 and get(rpm_high_2) < 5 and get(rpm_high_3) < 5 
		and get(parking_brake) == 1 
		and get(apu_n1) < 5 
		)
	then
