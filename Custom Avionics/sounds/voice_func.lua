...
function read_phrase()
	...
	if phrases_tbl[1][1] ~= 0 and get(enable_crew_vo) == 1 then playSample(phrases_tbl[1][1], 0) end
	move_phr(1)
	return timeout 
end
function dep_number(number) 
