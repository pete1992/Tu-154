...
defineProperty("radioalt_dh_left", globalPropertyf("tu154ce/gauges/alt/radioalt_dh_left")) 
...
function checklist_6()
	...
	if checklist_started then
		if stage == 1 and get(fishka_8) == 0 then stage = 2 stage_status = 0 end 
		if stage == 2 and get(fishka_9) == 0 then stage = 3 stage_status = 0 end 
		if stage == 3 and get(fishka_10) == 0 then stage = 4 stage_status = 0 end 
		if stage == 4 and get(fishka_11) == 0 then stage = 5 stage_status = 0 end 
