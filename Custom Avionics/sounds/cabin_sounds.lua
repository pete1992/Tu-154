...
defineProps({
    ...
    {"dh_set_L",              "sim/custom/gauges/alt/radioalt_dh_left",    globalPropertyf},
    {"dh_set_R",              "sim/custom/gauges/alt/radioalt_dh_right",   globalPropertyf},
    {"rv_angle_L",            "sim/custom/gauges/alt/radioalt_needle_left",globalPropertyf},
    {"rv_angle_R",            "sim/custom/gauges/alt/radioalt_needle_right",globalPropertyf},
    {"rv5_dh_signal_left",    "sim/custom/misc/rv5_dh_signal_left",        globalPropertyi},
    {"rv5_dh_signal_right",   "sim/custom/misc/rv5_dh_signal_right",       globalPropertyi},
    {"roll_main_mode",        "sim/custom/absu/roll_main_mode",            globalPropertyi},
    {"pitch_main_mode",       "sim/custom/absu/pitch_main_mode",           globalPropertyi},
    {"stu_mode",              "sim/custom/absu/stu_mode",                  globalPropertyi},
    {"absu_fail_signal",      "sim/custom/absu/absu_fail_signal",          globalPropertyi},
    {"main_gear_flaps",       "sim/custom/alarm/main_gear_flaps",          globalPropertyi},
    {"main_pressure",         "sim/custom/alarm/main_pressure",            globalPropertyi},
    {"speaker_auasp",         "sim/custom/alarm/speaker_auasp",            globalPropertyi},
    {"speaker_fuel",          "sim/custom/alarm/speaker_fuel",             globalPropertyi},
    {"speaker_speed",         "sim/custom/alarm/speaker_speed",            globalPropertyi},
    {"speaker_absu",          "sim/custom/alarm/speaker_absu",             globalPropertyi},
    {"fire_siren",            "sim/custom/fire/fire_siren",                globalPropertyi},
    {"srd_buzzer",            "sim/custom/switchers/eng/srd_buzzer",       globalPropertyi},
    {"fuel_buzzer",           "sim/custom/switchers/eng/fuel_buzzer",      globalPropertyi},
    {"srd_buzzer_cap",        "sim/custom/switchers/eng/srd_buzzer_cap",   globalPropertyi},
    {"fuel_buzzer_cap",       "sim/custom/switchers/eng/fuel_buzzer_cap",  globalPropertyi},
    {"srd_buzzer_test",       "sim/custom/buttons/eng/srd_buzzer_test",    globalPropertyi},
    ...
    {"light_open_left",       "sim/custom/anim/light_open_left",           globalPropertyf},
    {"light_open_right",      "sim/custom/anim/light_open_right",          globalPropertyf},
    {"airspeed",              "sim/flightmodel/position/indicated_airspeed",globalPropertyf},
    {"bus27_volt_L",          "sim/custom/elec/bus27_volt_left",           globalPropertyf},
    {"bus27_volt_R",          "sim/custom/elec/bus27_volt_right",          globalPropertyf},
    {"bus27_source_left",     "sim/custom/elec/bus27_source_left",         globalPropertyf},
    {"bus27_source_right",    "sim/custom/elec/bus27_source_right",        globalPropertyf},
    {"pilot_Z",               "sim/aircraft/view/acf_peZ",                 globalPropertyf},
    {"air_usage_L",           "sim/custom/bleed/air_usage_L",              globalPropertyf},
    {"air_usage_R",           "sim/custom/bleed/air_usage_R",              globalPropertyf},
    ...
    {"main_alarm_fail",       "sim/custom/failures/main_alarm_fail",       globalPropertyi},
    {"speaker_alarm_fail",    "sim/custom/failures/speaker_alarm_fail",    globalPropertyi},
...
function update()
    ...
    elseif get(srd_buzzer)==1 and get(main_pressure)==1 and power and external==0 and get(main_alarm_fail)==0 then
        ...
        if not isSamplePlaying(long_sirena) and short_sirena_timer>0.2 then playSample(long_sirena,1) end
