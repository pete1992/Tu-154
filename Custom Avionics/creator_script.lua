...
local dataref_filename = sasl.getAircraftPath() .. "/plugins/SASL/data/modules/Custom Module/DataRefsTu154_CB.txt" 
local save_filename = sasl.getAircraftPath() .. "/plugins/SASL/data/modules/Custom Module/dataref_creator_4.lua" 
