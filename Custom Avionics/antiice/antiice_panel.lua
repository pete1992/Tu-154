defineProperty("soi21_on", globalPropertyi("sim/custom/switchers/eng/soi21_on")) 
defineProperty("soi21_test", globalPropertyi("sim/custom/buttons/eng/soi21_test")) 
defineProperty("antiice_slats", globalPropertyi("sim/custom/switchers/eng/antiice_slats")) 
defineProperty("antiice_eng_1", globalPropertyi("sim/custom/switchers/eng/antiice_eng_1")) 
defineProperty("antiice_eng_2", globalPropertyi("sim/custom/switchers/eng/antiice_eng_2")) 
defineProperty("antiice_eng_3", globalPropertyi("sim/custom/switchers/eng/antiice_eng_3")) 
defineProperty("antiice_wing", globalPropertyi("sim/custom/switchers/eng/antiice_wing")) 
...
defineProperty("soi_work", globalPropertyf("sim/custom/lights/small/soi_work")) 
defineProperty("soi_ice_detected", globalPropertyf("sim/custom/lights/small/soi_ice_detected")) 
defineProperty("antiice_slats_lamp", globalPropertyf("sim/custom/lights/small/antiice_slats")) 
defineProperty("antiice_eng_1_lamp", globalPropertyf("sim/custom/lights/small/antiice_eng_1")) 
defineProperty("antiice_eng_2_lamp", globalPropertyf("sim/custom/lights/small/antiice_eng_2")) 
defineProperty("antiice_eng_3_lamp", globalPropertyf("sim/custom/lights/small/antiice_eng_3")) 
defineProperty("antiice_wings_lamp", globalPropertyf("sim/custom/lights/small/antiice_wings")) 
defineProperty("stab_temp", globalPropertyf("sim/custom/gauges/eng/stab_temp")) 
defineProperty("wing_temp", globalPropertyf("sim/custom/gauges/eng/wing_temp")) 
defineProperty("wing_heat_t", globalPropertyf("sim/custom/antiice/wing_heat_t")) 
defineProperty("stab_heat_t", globalPropertyf("sim/custom/antiice/stab_heat_t")) 
...
defineProperty("eng_heat_open_1", globalPropertyi("sim/custom/antiice/eng_heat_open_1")) 
defineProperty("eng_heat_open_2", globalPropertyi("sim/custom/antiice/eng_heat_open_2")) 
defineProperty("eng_heat_open_3", globalPropertyi("sim/custom/antiice/eng_heat_open_3")) 
defineProperty("ice_surfce_heat_on", globalPropertyi("sim/cockpit2/ice/ice_surfce_heat_on"))
defineProperty("ice_detected", globalPropertyi("sim/custom/antiice/ice_detected")) 
defineProperty("ice_detect_ok", globalPropertyi("sim/custom/antiice/ice_detect_ok")) 
...
defineProperty("wing_heating", globalPropertyi("sim/custom/antiice/wing_heating")) 
defineProperty("slat_heating", globalPropertyi("sim/custom/antiice/slat_heating")) 
