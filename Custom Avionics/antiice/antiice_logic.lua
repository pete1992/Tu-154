...
-- Register all DataRefs
defineProps({
    {"soi21_on",            "sim/custom/switchers/eng/soi21_on",                globalPropertyi},
    {"soi21_test",          "sim/custom/buttons/eng/soi21_test",                globalPropertyi},
    {"antiice_slats",       "sim/custom/switchers/eng/antiice_slats",           globalPropertyi},
    {"antiice_eng_1",       "sim/custom/switchers/eng/antiice_eng_1",           globalPropertyi},
    {"antiice_eng_2",       "sim/custom/switchers/eng/antiice_eng_2",           globalPropertyi},
    {"antiice_eng_3",       "sim/custom/switchers/eng/antiice_eng_3",           globalPropertyi},
    {"antiice_wing",        "sim/custom/switchers/eng/antiice_wing",            globalPropertyi},
    {"window_heat_1",       "sim/custom/switchers/ovhd/window_heat_1",          globalPropertyi},
    {"window_heat_2",       "sim/custom/switchers/ovhd/window_heat_2",          globalPropertyi},
    {"window_heat_3",       "sim/custom/switchers/ovhd/window_heat_3",          globalPropertyi},
    {"pitot_heat_1",        "sim/custom/switchers/ovhd/pitot_heat_1",           globalPropertyi},
    {"pitot_heat_2",        "sim/custom/switchers/ovhd/pitot_heat_2",           globalPropertyi},
    {"pitot_heat_3",        "sim/custom/switchers/ovhd/pitot_heat_3",           globalPropertyi},
    {"heat_ok_1",           "sim/custom/lights/small/heat_ok_1",                globalPropertyf},
    {"heat_ok_2",           "sim/custom/lights/small/heat_ok_2",                globalPropertyf},
    {"heat_ok_3",           "sim/custom/lights/small/heat_ok_3",                globalPropertyf},
    {"soi_work",            "sim/custom/lights/small/soi_work",                 globalPropertyf},
    {"soi_ice_detected",    "sim/custom/lights/small/soi_ice_detected",         globalPropertyf},
    {"antiice_slats_lamp",  "sim/custom/lights/small/antiice_slats",            globalPropertyf},
    {"antiice_eng_1_lamp",  "sim/custom/lights/small/antiice_eng_1",            globalPropertyf},
    {"antiice_eng_2_lamp",  "sim/custom/lights/small/antiice_eng_2",            globalPropertyf},
    {"antiice_eng_3_lamp",  "sim/custom/lights/small/antiice_eng_3",            globalPropertyf},
    {"antiice_wings_lamp",  "sim/custom/lights/small/antiice_wings",            globalPropertyf},
    {"stab_temp",           "sim/custom/gauges/eng/stab_temp",                  globalPropertyf},
    {"wing_temp",           "sim/custom/gauges/eng/wing_temp",                  globalPropertyf},
    {"wing_heat_t",         "sim/custom/antiice/wing_heat_t",                   globalPropertyf},
    {"stab_heat_t",         "sim/custom/antiice/stab_heat_t",                   globalPropertyf},
    ...
    {"eng_heat_open_1",     "sim/custom/antiice/eng_heat_open_1",               globalPropertyi},
    {"eng_heat_open_2",     "sim/custom/antiice/eng_heat_open_2",               globalPropertyi},
    {"eng_heat_open_3",     "sim/custom/antiice/eng_heat_open_3",               globalPropertyi},
    {"ice_surfce_heat_on",  "sim/cockpit2/ice/ice_surfce_heat_on",              globalPropertyi},
    {"ice_detected",        "sim/custom/antiice/ice_detected",                  globalPropertyi},
    {"ice_detect_ok",       "sim/custom/antiice/ice_detect_ok",                 globalPropertyi},
    ...
    {"wing_heating",        "sim/custom/antiice/wing_heating",                  globalPropertyi},
    {"slat_heating",        "sim/custom/antiice/slat_heating",                  globalPropertyi},
...
-- Load switch and button sound samples once
...
local wing_temp_act       = 0

-- Cache last switch/button states for sound logic
local lastStates = {
...
-- Resets all anti-ice switchers if all engines are off
...
-- Smoothly animate the stabilizer and wing temperature gauges
...
-- Play a sound when any anti-ice switch or button changes
local function checkControls()
    ...
    if changeDetected then playSample(switcher_sound, 0) end

    -- Play special sound for SOI21 test button change
...
-- Update all lamp brightnesses depending on voltage and anti-ice status
