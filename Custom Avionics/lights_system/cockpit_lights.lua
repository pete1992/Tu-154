...
заливающее освещение передней панели
заливающее освещение средний пульт
заливающее освещение верхней панели передн
заливающее освещение верхней панели задн
заливающее освещение панели БИ
левый фонарик
освещение салона
свет для левой боковой панели
defineProperty("l1_0", globalPropertyf("sim/weapons/vx[0]")) set(l1_0, 1)  
defineProperty("l1_1", globalPropertyf("sim/weapons/vx[1]")) set(l1_1, 0.7)  
defineProperty("l1_2", globalPropertyf("sim/weapons/vx[2]")) set(l1_2, 0.2)  
defineProperty("l1_3", globalPropertyf("sim/weapons/vx[3]")) set(l1_3, 0)  
defineProperty("l1_4", globalPropertyf("sim/weapons/vx[4]")) set(l1_4, 0.6) 
defineProperty("l1_5", globalPropertyf("sim/weapons/vx[5]")) set(l1_5, 0)  
defineProperty("l1_6", globalPropertyf("sim/weapons/vx[6]")) set(l1_6, 0)  
defineProperty("l1_7", globalPropertyf("sim/weapons/vx[7]")) set(l1_7, -90)  
defineProperty("l1_8", globalPropertyf("sim/weapons/vx[8]")) set(l1_8, 20)  
свет для правой боковой панели
defineProperty("l2_0", globalPropertyf("sim/weapons/vy[0]")) set(l2_0, 1)  
defineProperty("l2_1", globalPropertyf("sim/weapons/vy[1]")) set(l2_1, 0.7)  
defineProperty("l2_2", globalPropertyf("sim/weapons/vy[2]")) set(l2_2, 0.2)  
defineProperty("l2_3", globalPropertyf("sim/weapons/vy[3]")) set(l2_3, 0)  
defineProperty("l2_4", globalPropertyf("sim/weapons/vy[4]")) set(l2_4, 0.6) 
defineProperty("l2_5", globalPropertyf("sim/weapons/vy[5]")) set(l2_5, 0)  
defineProperty("l2_6", globalPropertyf("sim/weapons/vy[6]")) set(l2_6, 0)  
defineProperty("l2_7", globalPropertyf("sim/weapons/vy[7]")) set(l2_7, -90)  
defineProperty("l2_8", globalPropertyf("sim/weapons/vy[8]")) set(l2_8, 20)  
свет для передней панели
defineProperty("l3_0", globalPropertyf("sim/weapons/vz[0]")) set(l3_0, 1)  
defineProperty("l3_1", globalPropertyf("sim/weapons/vz[1]")) set(l3_1, 0.7)  
defineProperty("l3_2", globalPropertyf("sim/weapons/vz[2]")) set(l3_2, 0.2)  
defineProperty("l3_3", globalPropertyf("sim/weapons/vz[3]")) set(l3_3, 0)  
defineProperty("l3_4", globalPropertyf("sim/weapons/vz[4]")) set(l3_4, 0.6) 
defineProperty("l3_5", globalPropertyf("sim/weapons/vz[5]")) set(l3_5, 0)  
defineProperty("l3_6", globalPropertyf("sim/weapons/vz[6]")) set(l3_6, 0)  
defineProperty("l3_7", globalPropertyf("sim/weapons/vz[7]")) set(l3_7, -50)  
defineProperty("l3_8", globalPropertyf("sim/weapons/vz[8]")) set(l3_8, 0.5)  
свет для среднего пульта
defineProperty("l4_0", globalPropertyf("sim/weapons/x[0]")) set(l4_0, 1)  
defineProperty("l4_1", globalPropertyf("sim/weapons/x[1]")) set(l4_1, 0.7)  
defineProperty("l4_2", globalPropertyf("sim/weapons/x[2]")) set(l4_2, 0.2)  
defineProperty("l4_3", globalPropertyf("sim/weapons/x[3]")) set(l4_3, 1)  
defineProperty("l4_4", globalPropertyf("sim/weapons/x[4]")) set(l4_4, 0.9) 
defineProperty("l4_5", globalPropertyf("sim/weapons/x[5]")) set(l4_5, 0)  
defineProperty("l4_6", globalPropertyf("sim/weapons/x[6]")) set(l4_6, 0)  
defineProperty("l4_7", globalPropertyf("sim/weapons/x[7]")) set(l4_7, -50)  
defineProperty("l4_8", globalPropertyf("sim/weapons/x[8]")) set(l4_8, 1)  
свет для передней части верхнего щитка
defineProperty("l5_0", globalPropertyf("sim/weapons/y[0]")) set(l5_0, 1)  
defineProperty("l5_1", globalPropertyf("sim/weapons/y[1]")) set(l5_1, 0.7)  
defineProperty("l5_2", globalPropertyf("sim/weapons/y[2]")) set(l5_2, 0.2)  
defineProperty("l5_3", globalPropertyf("sim/weapons/y[3]")) set(l5_3, 0)  
defineProperty("l5_4", globalPropertyf("sim/weapons/y[4]")) set(l5_4, 0.5) 
defineProperty("l5_5", globalPropertyf("sim/weapons/y[5]")) set(l5_5, 0)  
defineProperty("l5_6", globalPropertyf("sim/weapons/y[6]")) set(l5_6, 0)  
defineProperty("l5_7", globalPropertyf("sim/weapons/y[7]")) set(l5_7, -160)  
defineProperty("l5_8", globalPropertyf("sim/weapons/y[8]")) set(l5_8, 20)  
свет для задней части верхнего щитка
defineProperty("l6_0", globalPropertyf("sim/weapons/z[0]")) set(l6_0, 1)  
defineProperty("l6_1", globalPropertyf("sim/weapons/z[1]")) set(l6_1, 0.7)  
defineProperty("l6_2", globalPropertyf("sim/weapons/z[2]")) set(l6_2, 0.2)  
defineProperty("l6_3", globalPropertyf("sim/weapons/z[3]")) set(l6_3, 0)  
defineProperty("l6_4", globalPropertyf("sim/weapons/z[4]")) set(l6_4, 0.4) 
defineProperty("l6_5", globalPropertyf("sim/weapons/z[5]")) set(l6_5, 0)  
defineProperty("l6_6", globalPropertyf("sim/weapons/z[6]")) set(l6_6, 0)  
defineProperty("l6_7", globalPropertyf("sim/weapons/z[7]")) set(l6_7, 0)  
defineProperty("l6_8", globalPropertyf("sim/weapons/z[8]")) set(l6_8, -1)  
свет для панели борт-инжинера
defineProperty("l7_0", globalPropertyf("sim/weapons/L[0]")) set(l7_0, 1)  
defineProperty("l7_1", globalPropertyf("sim/weapons/L[1]")) set(l7_1, 0.7)  
defineProperty("l7_2", globalPropertyf("sim/weapons/L[2]")) set(l7_2, 0.2)  
defineProperty("l7_3", globalPropertyf("sim/weapons/L[3]")) set(l7_3, 0)  
defineProperty("l7_4", globalPropertyf("sim/weapons/L[4]")) set(l7_4, 1.0) 
defineProperty("l7_5", globalPropertyf("sim/weapons/L[5]")) set(l7_5, 0)  
defineProperty("l7_6", globalPropertyf("sim/weapons/L[6]")) set(l7_6, 30)  
defineProperty("l7_7", globalPropertyf("sim/weapons/L[7]")) set(l7_7, -90)  
defineProperty("l7_8", globalPropertyf("sim/weapons/L[8]")) set(l7_8, 10)  
свет для панели борт-инжинера
defineProperty("l7_1_0", globalPropertyf("sim/weapons/N[0]")) set(l7_1_0, 1)  
defineProperty("l7_1_1", globalPropertyf("sim/weapons/N[1]")) set(l7_1_1, 0.7)  
defineProperty("l7_1_2", globalPropertyf("sim/weapons/N[2]")) set(l7_1_2, 0.2)  
defineProperty("l7_1_3", globalPropertyf("sim/weapons/N[3]")) set(l7_1_3, 0)  
defineProperty("l7_1_4", globalPropertyf("sim/weapons/N[4]")) set(l7_1_4, 0.7) 
defineProperty("l7_1_5", globalPropertyf("sim/weapons/N[5]")) set(l7_1_5, 0)  
defineProperty("l7_1_6", globalPropertyf("sim/weapons/N[6]")) set(l7_1_6, 30)  
defineProperty("l7_1_7", globalPropertyf("sim/weapons/N[7]")) set(l7_1_7, -30)  
defineProperty("l7_1_8", globalPropertyf("sim/weapons/N[8]")) set(l7_1_8, 20)  
свет для левого фонарика
defineProperty("l8_0", globalPropertyf("sim/weapons/M[0]")) set(l8_0, 1)  
defineProperty("l8_1", globalPropertyf("sim/weapons/M[1]")) set(l8_1, 0.7)  
defineProperty("l8_2", globalPropertyf("sim/weapons/M[2]")) set(l8_2, 0.2)  
defineProperty("l8_3", globalPropertyf("sim/weapons/M[3]")) set(l8_3, 0)  
defineProperty("l8_4", globalPropertyf("sim/weapons/M[4]")) set(l8_4, 1.0) 
defineProperty("l8_5", globalPropertyf("sim/weapons/M[5]")) set(l8_5, 0)  
defineProperty("l8_6", globalPropertyf("sim/weapons/M[6]")) set(l8_6, 0)  
defineProperty("l8_7", globalPropertyf("sim/weapons/M[7]")) set(l8_7, -90)  
defineProperty("l8_8", globalPropertyf("sim/weapons/M[8]")) set(l8_8, 10)  
свет в салоне
defineProperty("l9_0", globalPropertyf("sim/weapons/Prad[0]")) set(l9_0, 1)  
defineProperty("l9_1", globalPropertyf("sim/weapons/Prad[1]")) set(l9_1, 0.7)  
defineProperty("l9_2", globalPropertyf("sim/weapons/Prad[2]")) set(l9_2, 0.5)  
defineProperty("l9_3", globalPropertyf("sim/weapons/Prad[3]")) set(l9_3, 1)  
defineProperty("l9_4", globalPropertyf("sim/weapons/Prad[4]")) set(l9_4, 5) 
defineProperty("l9_5", globalPropertyf("sim/weapons/Prad[5]")) set(l9_5, 1)  
...
if toilet_timer_before < 0 then
	...
	if toilet_use_timer < 0 then
		toilet_use_timer = math.random(60, 300) 
		toilet_timer_before = math.random(120, 600) 
