...
setup_toggle_command(0, 1, "sim/lights/nav_lights_toggle",   globalPropertyi("sim/custom/lights/nav_lights_set"))   
setup_toggle_command(0, 1, "sim/lights/strobe_lights_toggle",   globalPropertyi("sim/custom/lights/strobe_set"))   
setup_toggle_command(0, 1, "sim/lights/spot_lights_toggle",   globalPropertyi("sim/custom/lights/tail_light_set"))   
