...
defineProperty("ext_light_cc_left", globalPropertyf("tu154ce/elec/ext_light_cc_left"))
defineProperty("ext_light_cc_right", globalPropertyf("tu154ce/elec/ext_light_cc_right"))
defineProperty("sim_nav_light", globalPropertyf("sim/cockpit2/switches/navigation_lights_on")) 
defineProperty("sim_beacon", globalPropertyf("sim/cockpit2/switches/beacon_on")) 
defineProperty("sim_strobes", globalPropertyf("sim/cockpit2/switches/strobe_lights_on")) 
...
defineProperty("sim_NW_L", globalPropertyf("sim/cockpit2/switches/landing_lights_switch[9]")) 
defineProperty("sim_NW_R", globalPropertyf("sim/cockpit2/switches/landing_lights_switch[8]")) 
defineProperty("sim_spot", globalPropertyf("sim/cockpit2/switches/spot_light_on")) 
defineProperty("sim_logo", globalPropertyf("sim/cockpit2/switches/generic_lights_switch[0]")) 
defineProperty("sim_wings_L", globalPropertyf("sim/cockpit2/switches/generic_lights_switch[1]")) 
defineProperty("sim_wings_R", globalPropertyf("sim/cockpit2/switches/generic_lights_switch[2]")) 
defineProperty("sim_cargo_1", globalPropertyf("sim/cockpit2/switches/generic_lights_switch[3]")) 
defineProperty("sim_cargo_2", globalPropertyf("sim/cockpit2/switches/generic_lights_switch[4]")) 
defineProperty("sim_lan_brt", globalPropertyf("sim/flightmodel2/lights/landing_lights_brightness_ratio[1]")) 
defineProperty("sim_landing", globalPropertyi("sim/cockpit/electrical/landing_lights_on")) 
defineProperty("light_open_left", globalPropertyf("tu154ce/anim/light_open_left")) 
defineProperty("light_open_right", globalPropertyf("tu154ce/anim/light_open_right")) 
defineProperty("white_light_left", globalPropertyi("tu154ce/lights/white_light_left")) 
defineProperty("white_light_right", globalPropertyi("tu154ce/lights/white_light_right")) 
defineProperty("beacon_light_B", globalPropertyi("tu154ce/lights/beacon_light_B")) 
defineProperty("beacon_light_T", globalPropertyi("tu154ce/lights/beacon_light_T")) 
defineProperty("gear_defl", globalPropertyf("sim/flightmodel2/gear/tire_vertical_deflection_mtr[1]")) 
defineProperty("deploy_ratio_1", globalPropertyf("sim/flightmodel2/gear/deploy_ratio[0]")) 
defineProperty("lamp_deploy_FL", globalPropertyf("sim/aircraft/parts/acf_gear_deploy[3]"))  
defineProperty("lamp_deploy_FR", globalPropertyf("sim/aircraft/parts/acf_gear_deploy[4]"))  
defineProperty("lamp_deploy_WL", globalPropertyf("sim/aircraft/parts/acf_gear_deploy[5]"))  
defineProperty("lamp_deploy_WR", globalPropertyf("sim/aircraft/parts/acf_gear_deploy[6]"))  
defineProperty("nav_lights_set", globalPropertyf("tu154ce/lights/nav_lights_set")) 
defineProperty("strobe_set", globalPropertyf("tu154ce/lights/strobe_set")) 
defineProperty("wing_light_left_set", globalPropertyf("tu154ce/lights/wing_light_left_set")) 
defineProperty("wing_light_right_set", globalPropertyf("tu154ce/lights/wing_light_right_set")) 
defineProperty("tail_light_set", globalPropertyf("tu154ce/lights/tail_light_set")) 
...
defineProperty("landing_ext_set_L", globalPropertyf("tu154ce/lights/landing_ext_set_L")) 
defineProperty("landing_ext_set_R", globalPropertyf("tu154ce/lights/landing_ext_set_R")) 
defineProperty("landing_mode_set_L", globalPropertyf("tu154ce/lights/landing_mode_set_L")) 
defineProperty("landing_mode_set_R", globalPropertyf("tu154ce/lights/landing_mode_set_R")) 
defineProperty("light_signal_set", globalPropertyf("tu154ce/lights/light_signal_set")) 
...
defineProperty("lan_lamp_fail_FL", globalPropertyi("tu154ce/failures/lan_lamp_fail_FL")) 
defineProperty("lan_lamp_fail_FR", globalPropertyi("tu154ce/failures/lan_lamp_fail_FR")) 
defineProperty("lan_lamp_fail_WL", globalPropertyi("tu154ce/failures/lan_lamp_fail_WL")) 
defineProperty("lan_lamp_fail_WR", globalPropertyi("tu154ce/failures/lan_lamp_fail_WR")) 
