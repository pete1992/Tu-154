defineProperty("mid_left_panel_int_set", globalPropertyf("sim/custom/lights/mid_left_panel_int_set")) 
defineProperty("left_panel_int_set", globalPropertyf("sim/custom/lights/left_panel_int_set")) 
defineProperty("right_panel_int_set", globalPropertyf("sim/custom/lights/right_panel_int_set")) 
defineProperty("mid_right_panel_int_set", globalPropertyf("sim/custom/lights/mid_right_panel_int_set")) 
defineProperty("ovhd_panel_int_set", globalPropertyf("sim/custom/lights/ovhd_panel_int_set")) 
defineProperty("cabinl_flood_set", globalPropertyf("sim/custom/lights/cabinl_flood_set")) 
defineProperty("azs_panel_flood_set", globalPropertyf("sim/custom/lights/azs_panel_flood_set")) 
defineProperty("cargo_light_1_set", globalPropertyf("sim/custom/lights/cargo_light_1_set")) 
defineProperty("cargo_light_2_set", globalPropertyf("sim/custom/lights/cargo_light_2_set")) 
defineProperty("tech_light_set", globalPropertyf("sim/custom/lights/tech_light_set")) 
defineProperty("gear_nacelle_light_set", globalPropertyf("sim/custom/lights/gear_nacelle_light_set")) 
defineProperty("nav_lights_set", globalPropertyi("sim/custom/lights/nav_lights_set")) 
defineProperty("strobe_set", globalPropertyi("sim/custom/lights/strobe_set")) 
defineProperty("wing_light_left_set", globalPropertyi("sim/custom/lights/wing_light_left_set")) 
defineProperty("wing_light_right_set", globalPropertyi("sim/custom/lights/wing_light_right_set")) 
defineProperty("tail_light_set", globalPropertyi("sim/custom/lights/tail_light_set")) 
defineProperty("day_night_set", globalPropertyi("sim/custom/lights/day_night_set")) 
...
defineProperty("light_signal_set", globalPropertyi("sim/custom/lights/light_signal_set")) 
