...
defineProperty("rpm",           globalPropertyf("tu154ce/gauges/engine/rpm_high_1")) -- assume same threshold for all
...
defineProperty("win_ice_anim",  globalPropertyf("tu154ce/anim/window_ice_1")) -- unified windshield ice
defineProperty("inlet_heat",    globalProperty("sim/cockpit2/ice/ice_inlet_heat_on_per_engine[0]"))
...
function update()
    ...
    set(pitot_heat, p1); set(AOA_heat, p1); set(globalPropertyf("tu154ce/antiice/ai_27_L_cc"),10*p1)
    -- Inlet heat
    local eng1 = bool(get(rel_ice_inlet_heat1)~=6 and get(rpm)>50 and get(antiice_eng)==1)
    set(inlet_heat, eng1); set(globalPropertyi("tu154ce/antiice/eng_heat_open_1"),eng1)
    -- Wing & slat heat current draw
    ...
    set(surf_heat, wh); set(globalPropertyi("tu154ce/antiice/slat_heating"),sh)
